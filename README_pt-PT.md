...
> Um prompt cinematográfico altamente detalhado para o Gemini Omni que visualiza memórias de infância como partículas douradas brilhantes emergindo de uma chave de brinquedo vintage em rotação.

#### 📝 Prompt

```
Fundo preto puro. Tomada cinematográfica macro estática de uma chave de brinquedo de corda antiga e enferrujada girando lentamente sozinha sobre uma superfície brilhante. À medida que gira, milhares de pequenas partículas brilhantes fluem da chave, formando memórias de infância em miniatura — um barco de papel flutuando na água da chuva, um pião, uma pipa voando no céu, uma carteira escolar de madeira, uma antiga televisão CRT e um trem de brinquedo circulando-os. Tudo se monta naturalmente a partir das partículas brilhantes com um movimento mágico e suave. Luz dourada quente, brilho volumétrico suave, atmosfera nostálgica e sonhadora, física de partículas realista, profundidade de campo cinematográfica, qualidade cinematográfica de ultra-alta definição. O quadro final permanece imóvel na miniatura completa do mundo da infância. 10 segundos, 16:9, 24fps.
```
...
> Um prompt estruturado de várias cenas para o Gemini Omni Flash que gera uma animação 3D de um personagem meditando na natureza e falando sobre a importância da prática.

#### 📝 Prompt

```
0-10 segundos - Vista lateral do @ gex praticando meditação na natureza ao anoitecer
10-20 segundos - continue a partir do último quadro do vídeo - ele fala sobre a importância da meditação
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2070155018796183552/img/sH2V38k50o6OdxLe.jpg" width="600" alt="Sequência de animação 3D de meditação">

**[🎬 Assistir vídeo →](https://x.com/sebatheepan/status/2070155888912953761)**

**Autor:** [Pan](https://x.com/sebatheepan) | **Fonte:** [Link](https://x.com/sebatheepan/status/2070155888912953761) | **Publicado:** Jun 25, 2026
...
### 🎯 74 mais prompts não mostrados aqui
...
<sub>🤖 Este README é gerado automaticamente. Última atualização: 2026-08-18T20:21:30.315Z</sub>
