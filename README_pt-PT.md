...
```
Crie um timelapse cinematográfico do preparo de uma luxuosa tigela de Mie Ayam (Macarrão com Frango Indonésio), com o tema 'Elegância Culinária'. Combine iluminação dourada quente, fotografia gastronômica macro e efeitos bokeh elegantes. Foque no macarrão dourado sendo misturado, pedaços de frango caramelizados e brilhantes, e um caldo rico e fumegante sendo servido em câmera lenta. Inclua gotas de óleo de pimenta aromático, cebolinhas frescas caindo e uma elegante tigela de cerâmica escura. Adicione partículas de vapor flutuantes e movimentos de câmera macro dinâmicos com um zoom suave. Crie uma atmosfera luxuosa, quente e de dar água na boca, misturando arte culinária com estética de alto padrão.
```
...
> Um prompt criativo de geração de vídeo onde um jogador de futebol chuta uma bola para fora de uma tela e, em seguida, salta para fora para fazer embaixadinhas na palma da mão de uma pessoa.

#### 📝 Prompt

```
O jogador de futebol chuta a bola para fora da tela... Eu a pego com a mão... Então, o jogador salta para fora da tela e começa a fazer embaixadinhas com a bola na palma da minha mão.
```
...
> Um prompt de animação para o Gemini Omni criar um efeito de surgimento 3D para um logotipo em um fundo de tela verde.

#### 📝 Prompt

```
Faça o logotipo (de referência) surgir de forma legal em um fundo de tela verde. Centralizado no quadro. Ele aparece do nada, monta-se e depois flutua no lugar. Efeito 3D legal.
```

<img src="https://pbs.twimg.com/media/HNYa_xmWgAAoWAE.jpg" width="600" alt="Animação de Logotipo 3D">

**[🎬 Assistir vídeo →](https://x.com/chrisfirst/status/2077877168730706019)**

**Autor:** [CHRIS FIRST](https://x.com/chrisfirst) | **Fonte:** [Link](https://x.com/chrisfirst/status/2077877168730706019) | **Publicado:** Jul 16, 2026

---
### Preservação da Identidade em Galope de Cavalo Islandês

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt cinematográfico de alta produção para uma sequência de equitação na Islândia, com foco na preservação da identidade de uma imagem de referência durante movimentos de câmera complexos.

#### 📝 Prompt

```
Use a imagem de referência masculina em anexo como a ÚNICA referência de identidade para o personagem principal.

Mantenha a identidade facial perfeita mesmo durante galopes rápidos, tomadas de drone, ângulos laterais e composições cinematográficas amplas.

Duração: 10 segundos.

O quadro inicial mostra imediatamente o personagem já galopando em velocidade máxima por um enorme vale islandês em um poderoso cavalo preto. O cavalo atravessa um rio raso, sobe uma colina gramada sem diminuir a velocidade e, em seguida, corre ao longo da borda de um penhasco com vista para cachoeiras e montanhas infinitas.

Produção fotorrealista em IMAX 65mm. Iluminação cinematográfica premium. Animação de cavalo hiper-realista. Detalhes ambientais de nível hollywoodiano.

Câmera:
Tracking montado no cavalo → tracking lateral → perseguição de drone FPV → revelação aérea épica.

Trilha Sonora:
Orquestra celta épica, trompas, coral, tambores taiko, cordas emocionantes.

Som Ambiente:
Cascos galopando, respingos de rio, movimento de sela de couro, vento, cachoeiras distantes, pássaros.

Sem diálogo.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2077790013799206912/img/JiItvZPzotkWNxrm.jpg" width="600" alt="Preservação da Identidade em Galope de Cavalo Islandês">

**[🎬 Assistir vídeo →](https://x.com/vireonixx/status/2077790049618547067)**

**Autor:** [Virena](https://x.com/vireonixx) | **Fonte:** [Link](https://x.com/vireonixx/status/2077790049618547067) | **Publicado:** Jul 16, 2026

---
### Vlog aconchegante de organização de estante

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt de vídeo detalhado para um vlog com estética de filmadora mini DV portátil, apresentando uma jovem organizando livros com sons ASMR satisfatórios e iluminação natural.

#### 📝 Prompt

```
CÂMERA / VISUAL: Filmagem de câmera mini DV portátil feita pela própria pessoa. Leve tremor nas mãos, busca de foco ocasional, enquadramento imperfeito, ajustes naturais de zoom, qualidade de imagem suave estilo fita, granulação sutil, mudanças realistas de exposição automática devido à luz quente da tarde. Tons de pele naturais, leve desfoque de movimento, estética autêntica de filmadora doméstica.
ESTILO: Vlog aconchegante de organização de estante com elementos suaves de ASMR. Ritmo relaxado, diálogos mínimos, momentos espontâneos. Foco em sons satisfatórios: páginas virando, lombadas de livros batendo, pano de limpeza passando, prateleiras se movendo suavemente.
SUJEITO: Jovem na casa dos 20 anos, cabelos longos e ondulados, camisa de flanela oversized, óculos de leitura no topo da cabeça. Energia calma e reflexiva enquanto reorganiza.
CENÁRIO: Pequeno canto de leitura em uma tarde tranquila de fim de semana. Luz quente através das cortinas, uma estante semi-vazia, pilhas de livros no chão.
STORYBOARD:
→ (2s, plano médio apoiado) Coloca a câmera em uma mesa lateral, senta-se perto da estante. "Finalmente organizando meus livros por cor."
→ (2s, plano zenital) Tira os livros da prateleira, separa-os em pilhas.
→ (2s, close-up) Limpa a poeira da prateleira vazia com um pano.
→ (2s, plano portátil) Folheia um livro antigo, pausando em uma página. "Eu tinha esquecido que tinha este."
→ (2s, plano de detalhe) Organiza os livros por cor, deslizando-os para o lugar. Sem diálogo.
→ (2s, plano médio) Adiciona uma pequena planta e uma vela à prateleira. "Só precisa de um pouco de decoração."
→ (2s, plano macro) Alinha as lombadas dos livros, dando batidinhas para igualar.
→ (2s, plano apoiado) Afasta-se para verificar o arranjo à distância.
→ (2s, plano final quente) Admira a estante pronta, sorriso feliz. "Muito melhor."
→ (1.5s, plano final) Estende a mão em direção à câmera. "Até logo." A mão cobre a lente conforme a gravação termina.
NOTAS DE ÁUDIO: Ambiente natural, virar de páginas, limpeza de poeira e deslizamento de livros devem ser claramente audíveis. Diálogo baixo e casual.
NOTAS DE REALISMO: Linguagem corporal autêntica, piscadas naturais, sorrisos genuínos, pausas ocasionais para pensar, enquadramento imperfeito, respiração de foco, mudanças de luz quente da tarde. Deve parecer um vlog de organização pessoal genuíno feito em uma filmadora doméstica, não uma produção comercial.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2077761124582543360/img/NROUVc0jpf1UZ9LZ.jpg" width="600" alt="Vlog aconchegante de organização de estante">

**[🎬 Assistir vídeo →](https://x.com/Strength04_X/status/2077761335585280363)**

**Autor:** [𝐌](https://x.com/Strength04_X) | **Fonte:** [Link](https://x.com/Strength04_X/status/2077761335585280363) | **Publicado:** Jul 16, 2026

---
### Revelação de Produto com Drone FPV em Cânion Desértico

![English](https://img.shields.io/badge/lang-English-blue)

> Uma sequência cinematográfica de drone FPV em alta velocidade através de cânions desérticos acidentados, terminando com uma revelação nítida do produto em um planalto ensolarado.

#### 📝 Prompt

```
{
  "description": "Uma tomada cinematográfica de drone FPV em alta velocidade começa bem acima de dramáticos penhascos desérticos ao amanhecer. O drone mergulha abruptamente em cânions rochosos acidentados, passando rente a dunas de areia e correndo entre enormes paredes de pedra vermelha. O vento levanta rastros de poeira enquanto o drone acelera, passando por estreitos arcos naturais de pedra e cumes iluminados pelo sol. No meio do caminho, o movimento diminui gradualmente à medida que o drone emerge em um amplo planalto desértico, revelando uma única lata de Red Bull gelada sobre uma laje de pedra rústica, com condensação visível e brilhando sob a luz da manhã. Sem texto.",
  "style": "cinematográfico, comercial de esportes radicais hiper-realista",
  "camera": "perspectiva de drone FPV em primeira pessoa com voo agressivo em alta velocidade pelo cânion, transicionando para uma revelação cinematográfica lenta, suave e controlada",
  "lighting": "luz do início do amanhecer com destaques quentes, forte iluminação de contorno nas formações rochosas, sombras de alto contraste; reflexos nítidos e destaques de condensação na lata de Red Bull",
  "environment": "vasta paisagem de cânion desértico com penhascos de pedra vermelha, cânions estreitos, dunas de areia, poeira levada pelo vento e uma clareira em um planalto aberto",
  "motion": "movimento aéreo muito rápido com mergulhos acentuados, passagens próximas pelo cânion e curvas fechadas; transição gradual para câmera lenta e estabilização suave para a revelação final",
  "ending": "um momento poderoso e silencioso no planalto desértico aberto; a lata de Red Bull centralizada na laje de pedra enquanto a câmera orbita suavemente e se aproxima, enfatizando energia, frescor e impacto",
  "aspect_ratio": "16:9",
  "duration": "10 segundos",
  "text": "nenhum",
  "keywords": [
    "drone FPV",
    "movimento cinematográfico ultrarrápido",
    "voo em cânion desértico",
    "revelação de produto hiper-realista",
    "comercial de energético",
    "final em câmera lenta",
    "sem texto"
  ]
}
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2077736758104723456/img/Czy7V5pZUnqzGTlz.jpg" width="600" alt="Revelação de Produto com Drone FPV em Cânion Desértico">

**[🎬 Assistir vídeo →](https://x.com/MrDasOnX/status/2077736805416505855)**

**Autor:** [Mr Das](https://x.com/MrDasOnX) | **Fonte:** [Link](https://x.com/MrDasOnX/status/2077736805416505855) | **Publicado:** Jul 16, 2026
...
> Um prompt de vídeo cinematográfico altamente detalhado para o Gemini Omni, criando uma sequência de road movie de cinco planos com iluminação de golden hour e detalhes consistentes da personagem.

#### 📝 Prompt

```
Crie uma sequência de road movie cinematográfica ultra-fotorrealista de 10 segundos inspirada em *Nomadland*, *A Vida Secreta de Walter Mitty* e *Na Natureza Selvagem*.

Use a imagem de referência feminina fornecida como protagonista. Preserve a identidade facial exata, o penteado, o tom de pele, as proporções corporais, a continuidade das roupas e as expressões ao longo de toda a sequência.

## ESTILO

Cinematografia de golden hour.
...
A protagonista dirige sozinha por uma rodovia costeira deserta ao pôr do sol.

### PLANO 2 (0:02–0:04)

Ela nota uma pequena placa de madeira com os dizeres:
...
A estrada sobe acima da costa, revelando uma vista panorâmica deslumbrante do oceano.

### PLANO 4 (0:06–0:08)

Ela para o carro, sai e sente a brisa do oceano.

### PLANO 5 (0:08–0:10)

Um plano aberto de drone mostra ela sozinha no penhasco enquanto as ondas quebram abaixo.
...
*"Nem todo caminho errado é um erro."*
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2075765489247383552/img/cFbChjHjOg7W09WZ.jpg" width="600" alt="Sequência de Road Movie Cinematográfico Inspirada em Nomadland">

**[🎬 Assistir vídeo →](https://x.com/vireonixx/status/2075765549796340071)**

**Autor:** [Virena](https://x.com/vireonixx) | **Fonte:** [Link](https://x.com/vireonixx/status/2075765549796340071) | **Publicado:** Jul 11, 2026
...
---
### Zoom Cinematico (Push-In) de Imagem para Vídeo
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2075153215952162816/img/SXIdMfPuasbXTp8X.jpg" width="600" alt="Zoom Cinematico (Push-In) de Imagem para Vídeo">
...
---
### Sequência de Combate com Robô de Ficção Científica
...
Tecnologia de futuro próximo realista.
...
"O mundo estava a um segundo do fim."
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2075176434931560448/img/r1khnveDSRsyTFKa.jpg" width="600" alt="Sequência de Combate com Robô de Ficção Científica">
...
---
### Transformação de Pug em Lobo no Reflexo
...
```
Um pug fofo sentado em um estúdio, olhando para um espelho grande sob uma iluminação diurna dramática e de alto contraste. No reflexo do espelho, em vez do pug, um lobo feroz e majestoso olha de volta com uma expressão poderosa e confiante. A câmera dá um zoom lento, contrastando o pug orgulhoso com seu reflexo selvagem e ancestral. Clima humorístico, porém inspirador, estilo cinematográfico, hiperdetalhado.
...
3-7s | A Revelação: A câmera faz um movimento lento de pan e avança em direção ao espelho. À medida que o reflexo se torna nítido, ele transita suavemente para mostrar um lobo cinzento enorme e majestoso olhando de volta com olhos ferozes e confiantes.

7-10s | O Contraste e Clímax: Uma tela dividida ou um ângulo por cima do ombro destacando o contraste: o pug fofo da vida real parecendo orgulhoso, justaposto ao lobo poderoso e ancestral no reflexo. A iluminação cinematográfica se intensifica antes de desaparecer para o preto.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2075172932792254464/img/-JF8X4hZDCSe2lKd.jpg" width="600" alt="Transformação de Pug em Lobo no Reflexo">
...
> Um prompt curto e eficaz para animar um pôster de viagem estático em um cartão-postal em movimento com nuvens à deriva e reflexos no oceano.

#### 📝 Prompt

```
transforme este pôster de viagem em um cartão-postal em movimento: nuvens à deriva, gaivotas cruzando o quadro, reflexos no oceano, movimento suave de câmera, 10s
```
...
> Uma série cinematográfica de prompts de vídeo que descreve um Velho Oeste pré-histórico onde cowboys montam dinossauros por cânions e planícies, com iluminação de nascer e pôr do sol.

#### 📝 Prompt

```
Take de acompanhamento cinematográfico, nascer do sol sobre um majestoso cânion de rocha vermelha no Velho Oeste. Um cowboy em trajes tradicionais da fronteira está montado nas costas de um grande Pterossauro, voando suavemente pelo ar sobre o terreno acidentado. Fotorrealista, 4k, iluminação volumétrica.

Take de estabelecimento amplo ao anoitecer. Um cowboy descansa ao lado de uma fogueira quente em uma planície gramada. No plano de fundo imediato, um Triceratops massivo e realista atrelado a uma carroça de madeira descansa pacificamente. Iluminação suave e cinematográfica de crepúsculo.

Take de acompanhamento em ângulo baixo em um deserto empoeirado durante o dia. Um Braquiossauro colossal equipado com sela e carga caminha majestosamente pela tela, cercado por um rebanho agitado de dinossauros menores e cowboys montados neles. Reflexos de lente e poeira atmosférica.

Take de silhueta dramática à noite. Um cowboy está no centro apontando um revólver, ladeado por dois raptores emplumados agressivos. A cena é brilhantemente retroiluminada por um fogo massivo e intenso vindo de uma estrutura em chamas atrás deles. Alto contraste, orientado para ação.

Take épico de silhueta ampla durante o pôr do sol na hora dourada. Um cowboy cavalga sobre um massivo Tiranossauro Rex que caminha lentamente pela planície desértica plana. O sol massivo está baixo no horizonte, criando uma imagem final marcante e bela.
```
...
---
### MV de Dança de Casal em Tinta Pastel

![日本語](https://img.shields.io/badge/lang-日本語-green)

> Um prompt abrangente para gerar um videoclipe estilizado de alta qualidade, apresentando dois personagens com efeitos visuais distintos, estética de tinta pastel e efeitos desenhados à mão sincronizados.

#### 📝 Prompt

```
Use 2 imagens de referência. Trate a imagem1 como Pessoa A e a imagem2 como Pessoa B. Represente a Pessoa A e a Pessoa B como personagens que aparecem em um videoclipe (MV) live-action, mantendo as características faciais, penteado, tipo físico, expressão, impressão do traje, atmosfera e identidade de cada personagem das imagens de referência. Não misture as duas pessoas. Não troque rostos, penteados, trajes, físicos, vibrações, efeitos visuais (VFX) ou traços de personalidade. Mantenha a personalidade individual de cada imagem de referência e retrate-as claramente como indivíduos distintos. Integre decorações ou silhuetas características das imagens de referência naturalmente como trajes de fantasia para um MV live-action. Mostre texturas realistas, balanço de cabelo, movimento de tecido, reflexos em acessórios, textura da pele e luz e sombra. O estilo geral deve ser um MV de fantasia live-action fofo, elegante e transparente. O fundo não é um local do mundo real, mas um 'Palco de Sonhos em Tinta Pastel' para um MV live-action. Organize um espaço de estúdio branco suave com tinta pálida, luz de aquarela, vidro translúcido, tecido de seda esvoaçante, anéis transparentes, um piso levemente reflexivo, fragmentos de papel flutuantes, círculos semelhantes a bolhas de sabão e partículas de poeira estelar. Foque em cores pastéis suaves como branco leitoso, azul bebê, lavanda, rosa pálido, creme amarelado, verde menta e ciano claro. As cores não devem emitir luz forte, mas parecer sangrar levemente. O fundo não é estático desde o início; sincronizado com 118 BPM, nuvens de tinta pálida, luz de aquarela, anéis transparentes, reflexos de vidro, tecido e partículas de luz expandem-se, fluem, balançam e derretem lentamente. Adicione efeitos visuais (VFX) fofos estilo tinta e efeitos delicados desenhados à mão. A tinta é apresentada como aquarela transparente, marcas de pincel pálidas, respingos leitosos, pequenos grãos de tinta e borrões que se espalham no ar. Efeitos desenhados à mão aparecem momentaneamente como linhas brancas finas, contornos pastéis pálidos, pequenas estrelas, raios finos, linhas de velocidade desenhadas à mão, linhas onduladas e rastros brilhantes. Balance as linhas levemente para manter um calor artesanal. Os VFX da Pessoa A devem ser nítidos e transparentes, com linhas finas, anéis transparentes, ondulações de vidro líquido e rastros desenhados à mão que reagem aos ombros, pulsos, pés e giros. Os VFX da Pessoa B devem ser suaves e doces, com borrões de tinta pálida, poeira estelar, pequenas flores de luz, pincéis suaves semelhantes a fitas e brilhos desenhados à mão que reagem às pontas dos dedos, cabelo, trajes e giros. No momento em que se aproximam, os VFX de anel da Pessoa A e os VFX de poeira estelar da Pessoa B se sobrepõem momentaneamente como ondulações pálidas de luz antes de se separarem imediatamente. Os VFX não devem esconder rostos, olhos, linhas corporais, membros, detalhes de trajes ou a dança. Os trajes são glamorosamente redesenhados para um MV live-action, mantendo a visão de mundo da imagem de referência, adicionando materiais brilhantes, camadas, jaquetas curtas, tecidos esvoaçantes, correntes, cintos, fitas, acessórios, botas, luvas, peças metálicas, transparência e cores de destaque. A Pessoa A e a Pessoa B mostram um senso de serem um casal, mas suas personalidades de traje e VFX são claramente distintas. Cabelo, tecidos, fitas, acessórios e decorações características balançam naturalmente com a dança. As expressões são fofas e equilibradas, mostrando uma distância típica de casal. Quando um olha para a câmera, o outro olha para o parceiro ou levemente para o lado; eles não fazem a mesma expressão simultaneamente. A impressão geral é uma caracterização live-action da imagem1 e imagem2 em um MV de dança de casal em um mundo de tinta pastel pálida. A Pessoa A é legal e nítida; a Pessoa B é suave e glamorosa. O fundo é fofo, mas não parece barato, movendo-se lindamente com tinta aquarela transparente e VFX desenhados à mão. Priorize rostos, penteados, tipos físicos, expressões e silhuetas. Sem sobreposições de texto, legendas, logotipos ou caracteres legíveis. Sem grafite, arte em spray, neon forte, estilo cibernético ou fundos de paisagem normais. Sem duplicação de pessoas, sem novas pessoas, sem sincronização perfeita, sem cópia simétrica, sem ficar parado e sem apenas caminhar. Use uma ou mais imagens de referência. Trate todas as pessoas/personagens nas imagens de referência como protagonistas. Se houver 1 imagem, apresente 1 pessoa; se 2 imagens, 2 pessoas; se 3 imagens, 3 pessoas, fazendo com que todas apareçam simultaneamente no mesmo vídeo. 15 segundos, 60fps. Um vídeo de dança de alta qualidade no estilo de um MV de conceito idol. Garanta um ritmo adequado para um MV curto, coreografia fofa e efeitos 2D desenhados à mão sincronizados. Descreva movimentos suaves para cabelo, roupas, acessórios, mãos, passos, giros, olhar e efeitos. Coloque todos no mesmo fundo, espaço de filmagem e cena de MV de uma só vez. Não mude o fundo para cada imagem de referência. Não divida em cenas diferentes por pessoa. Não troque personagens no meio do caminho. Não os apresente um por um. Para múltiplas imagens de referência, trate cada uma como uma pessoa independente. Não misture rostos, penteados, cores de cabelo, biotipos, trajes, acessórios, gêneros, faixas etárias ou vibrações. Não os faça um par com o mesmo rosto, cabelo ou roupa. Se usar referências masculinas e femininas, mantenha-as claramente como masculino e feminino. Priorize a retenção da caracterização das imagens de referência, incluindo textura, estilo artístico, atmosfera e personalidade. Mesmo que as texturas difiram entre as referências, mantenha-as individuais para cada personagem. Não force um estilo artístico uniforme em todos. Se corpos inteiros ou trajes não estiverem visíveis, complemente-os naturalmente com base nas cores, materiais, silhuetas e traços de personalidade de cada imagem. As partes complementares devem seguir a mesma direção da respectiva imagem de referência. Não pegue emprestado características de outros personagens. Fixe o fundo como um único espaço de filmagem de MV comum: um estúdio interno, um quarto perto de uma janela ou um espaço de filmagem simples. Use luz natural suave e um fundo organizado onde todos pareçam protagonistas. Não mude o local por tomada; apenas mude os ângulos da câmera dentro do mesmo espaço. Analise as semelhanças entre as imagens de referência para criar um único espaço de MV de conceito idol, ajustando a atmosfera (brilhante, pálida, calma, úmida, fria, fofa, etc.). A música é uma canção japonesa; não use músicas reais existentes. O conceito do vídeo é um MV de conceito curto onde todos os personagens dançam juntos de forma fofa e impressionante no mesmo espaço. Prioridade: todos existem simultaneamente, todos parecem fofos, o MV é memorável e a dança se integra com efeitos 2D desenhados à mão. Use arranjos lado a lado, triangulares, diagonais ou de frente para trás para que todos fiquem visíveis. Todos dançam ao mesmo tempo; sem partes apenas solo, ficar parado ou direção de local separado. Não use 'fofura' de modelo; analise as referências para criar uma fofura de conceito idol coesa. Personagens brilhantes: fofura saltitante. Personagens calmos: fofura elegante. Personagens legais: fofura tímida ou equilibrada. Personagens efêmeros: fofura suave. Personagens estilo urbano: fofura rude e brincalhona. Coreografia: dança solo se 1 pessoa, dança em grupo se 2+. Inclua momentos sincronizados e momentos que mostram individualidade. Use mãos, ombros, pescoço, cintura, pés, olhar, giros e poses naturalmente. Os movimentos devem ser fofos, fáceis de imitar e memoráveis. Nada excessivamente infantil, excessivamente sexy, intensamente agressivo, saltos não naturais ou movimentos aleatórios. Efeitos 2D desenhados à mão são gerados automaticamente com base na análise do personagem. Garanta que formas, linhas, texturas, cores, densidade e tempo sejam adequados para todos. Unifique a tela com um design de MV enquanto dá aos personagens pequenas variações no estilo de cor/linha conforme necessário. Os efeitos são gráficos em movimento desenhados à mão compostos sobre o vídeo, assemelhando-se a animações 2D rudes e fofas como giz de cera, lápis, pastel a óleo ou tinta pálida. Sincronize-os com mãos, rostos, pés, movimentos corporais, giros, olhar e poses. Equilibre-os pela tela sem favorecer uma pessoa. Não esconda rostos ou corpos demais. Configure como se filmado com 5 câmeras, alternando a cada 2 segundos: Frente, Topo, Esquerda, Direita, Trás. Mantenha o mesmo espaço de fundo, mudando apenas os ângulos. Priorize composições onde todos estejam visíveis, incluindo planos de corpo inteiro ou do joelho para cima. Sem closes que cortem as pessoas. Não fixe a câmera completamente; balance-a levemente no ritmo (pequenos saltos, zoom, balanços leves). Não use balanço de câmera na mão desordenado. 0.0-2.0s: Câmera frontal. Todos aparecem no mesmo fundo. Corpo inteiro ou do joelho para cima. Organize lado a lado ou em formação. Todos executam ritmicamente uma pose de introdução fofa e pequenos passos que se encaixam em sua personalidade. Efeitos 2D desenhados à mão que combinam com a atmosfera aparecem perto das mãos e rostos. 2.0-4.0s: Câmera superior (overhead). Todos entram no quadro e reconhecem a câmera. Coordene gestos faciais e acentos de mão enquanto mantém traços de personalidade individuais. 4.0-6.0s: Câmera esquerda. Coreografia curta usando orientação corporal, cintura, ombros e mãos. Mantenha a distância do joelho para cima até o corpo inteiro. Efeitos desenhados à mão fluem por todos seguindo rastros de movimento. 6.0-8.0s: Câmera direita. Todos ficam de frente para o lado oposto enquanto reconhecem a câmera. Coreografia fofa sincronizada com a batida usando ombros, mãos e pés. Mostre passos claros com uma composição natural. Efeitos derivados das cores/formas de referência aparecem nos ombros e pés. 8.0-10.0s: Câmera traseira. Cabelo e trajes balançam suavemente. Composição de silhueta natural. Todos olham para trás sobre o ombro para a câmera, sincronizados ou levemente escalonados. Inclui giros e poses de mão com rastros de efeito. 10.0-12.0s: Câmera frontal (Clímax). Do joelho para cima até o corpo inteiro. Coreografia de grupo memorável usando o corpo inteiro. Aumente a densidade do efeito. Espalhe formas/linhas pela tela. Adicione pequenos balanços de câmera nos 'hits'. 12.0-14.0s: Câmera superior. Todos olham para cima com gestos fofos de rosto/mão. Efeitos desenhados à mão se espalham suavemente das mãos. Mantenha toda a consistência de rosto/cabelo. 14.0-15.0s: Cena final. De frente ou levemente diagonal. Pose final do grupo fluindo da dança. Não necessariamente um close no rosto; escolha a composição de grupo mais atraente (corpo inteiro até o busto). Sem zooms repentinos, cortes bruscos ou closes de rosto abruptos no final. Use uma aproximação de câmera suave ou uma parada leve. Enfatize a pose através da imobilidade corporal, formas das mãos, olhar e movimento persistente de cabelo/tecido e uma curta explosão de efeitos 2D. Restrições: Nenhum personagem além dos protagonistas. Não mescle múltiplas referências em uma pessoa. Não misture rostos masculinos e femininos. Não troque penteados/trajes. Sem 'twin-ificação'. Não compartilhe traços de personagem apenas porque compartilham um fundo. Sem trajes contradizendo as referências. Sem poses/expressões/ícones/cores inconsistentes com os personagens. Não use o mesmo modelo para cada efeito/gesto. Garanta que a dança e os efeitos estejam perfeitamente sincronizados. Os efeitos devem ser parte da coreografia, não muito fracos. Sem explosões, fogo, fumaça, glitch excessivo ou magia chamativa. Sem texto, legendas, logotipos ou marcas d'água. Renderize todos os 15 segundos suavemente a 60fps.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2074800449652424704/img/XC2gobNaI_RucnzU.jpg" width="600" alt="MV de Dança de Casal em Tinta Pastel">
...
Câmera:
Perseguição de drone FPV já em movimento → acompanhamento lateral → câmera montada na roda → revelação aérea massiva.

Trilha Sonora:
Orquestra cinematográfica inspiradora, percussão rítmica, violão acústico, cordas emocionantes.

Som Ambiental:
Clique do cubo livre, trocas de marcha, ruído dos pneus, vento da montanha, pássaros.
...
> Um prompt de vídeo cinematográfico para o Gemini gerar uma paisagem surreal com um olho gigante piscando e pequenos exploradores humanos, completo com uma linha do tempo detalhada de 10 segundos de movimento.

#### 📝 Prompt

```
Paisagem surreal fotorrealista. Um olho humano gigante e altamente detalhado, com íris azul e esclera avermelhada, pisca lentamente no centro. Ele é cercado por estruturas pulsantes, vermelhas, carnudas e em formato de estrela, cada uma contendo um olho azul piscando. Pequenas figuras humanas realistas vestindo ternos caminham pelo terreno carnudo, examinando os olhos.
...
6-10s: Plano aberto estabelecendo a escala. Pequenas figuras humanas caminham pelo terreno carnudo, examinando as estruturas enquanto todos os olhos focam na câmera.
```
...
> Um prompt de geração de vídeo altamente detalhado para criar motion graphics sofisticados com qualidade comercial. Ele orienta o modelo a usar uma imagem de referência sem modificações, aplicando animações complexas como rotações 3D, divisões e tipografia sincronizada para visualizar um marco de receita.

#### 📝 Prompt

```
Use a imagem anexada como única referência. Não altere a ilustração, personagem, design, cores, formas, proporções ou detalhes da imagem de referência. Use sempre a mesma imagem, animando apenas sua posição, escala, rotação, rotação 3D e duplicação. Não gere ou redesenhe novas ilustrações. 16:9, 10 segundos, motion graphics de alta qualidade. Fundo simples e limpo. Design de movimento sofisticado com qualidade comercial, como se produzido no After Effects.

No início do vídeo, a imagem anexada aparece no centro da tela. A imagem aumenta de escala rapidamente e, em seguida, repete ritmicamente o zoom in e zoom out. A animação de escala salta vigorosamente com um ritmo que acompanha uma batida musical.

Em seguida, a imagem continua a escalar levemente enquanto gira 360 graus em alta velocidade ao redor do seu centro. Depois, transita suavemente para uma rotação 3D no eixo Y (giro de cartão), com a câmera movendo-se levemente para frente e para trás para criar profundidade.

No momento em que a rotação 3D termina, a imagem se divide instantaneamente de 1 para 4 e explode em direção aos quatro cantos. Cada uma das quatro imagens continua a se mover enquanto rotaciona e escala.

Imediatamente após, as 4 imagens se dividem rapidamente em 16, espalhando-se uniformemente pela tela. As 16 imagens repetem a rotação, rotação 3D e escala em tempos diferentes, formando motion graphics de alta velocidade.

No final, todas as 16 imagens são sugadas para o centro em alta velocidade e fundidas em uma só. A câmera dá um zoom potente em direção à imagem fundida, terminando o vídeo com um desfecho impactante.

Mantenha um desenvolvimento energético e bem ritmado, sem pausas ao longo do vídeo. A animação deve ser suave e nítida, alcançando motion graphics de alta qualidade adequados para comerciais, videoclipes ou anúncios no YouTube.

Efeitos de Tipografia (Prompt Adicional)

Sincronize a tipografia perfeitamente com o movimento da imagem. Coloque o texto em uma camada à frente da imagem usando fontes sem serifa, modernas e extra-bold. Use ativamente desfoque de movimento (motion blur), escala e rotação para criar motion graphics integrados à imagem.

0-2 segundos: 'X' aumenta drasticamente, pulsando com a escala da imagem.
2-4 segundos: 'Girigiri' (Por pouco) desliza para a esquerda e para a direita em alta velocidade com desfoque de movimento.
4-6 segundos: Sincronizado com a rotação 3D, 'Shueki' (Receita) salta do fundo e aumenta significativamente de escala.
6-8 segundos: Quando a imagem se divide em 4 e 16, múltiplos ícones 'X' aparecem e se espalham ritmicamente pela tela.
8-10 segundos: Todas as imagens e textos se reúnem no centro, com 'X', 'Girigiri' e 'Shueki' sobrepondo-se poderosamente para o final, criando um encerramento impressionante tipo logotipo com um zoom da câmera.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2073354982523609088/img/98Ey2dRo4vfvov5v.jpg" width="600" alt="Motion Graphics Profissionais com Imagem de Referência">

**[🎬 Assistir vídeo →](https://x.com/Naonekozamurai/status/2073355820704907627)**

**Autor:** [なお](https://x.com/Naonekozamurai) | **Fonte:** [Link](https://x.com/Naonekozamurai/status/2073355820704907627) | **Publicado:** Jul 4, 2026

---
### Vídeo de selfie de gato na montanha-russa

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt bem-humorado em estilo POV que retrata um homem e seu gato andando em uma montanha-russa, completo com uma linha do tempo detalhada de 10 segundos de suas reações.

#### 📝 Prompt

```
Vídeo divertido em estilo selfie de um homem barbudo gritando enquanto segura seu gato malhado laranja em uma montanha-russa veloz. Ambos estão com os olhos arregalados e bocas abertas em um terror sincronizado. Efeitos de vento forte, trilhos azuis retorcidos e um céu nublado passando rapidamente ao fundo em alta velocidade.

Linha do tempo de 10 segundos:

0:00 - 0:02: A montanha-russa atinge o topo. O homem e o gato olham para baixo, com os olhos arregalados em antecipação.

0:02 - 0:05: A queda começa. O vento os atinge instantaneamente. O homem começa a gritar.

0:05 - 0:08: Velocidade máxima. Tanto o homem quanto o gato estão gritando com as bocas bem abertas. Bigodes e cabelos balançam violentamente. O fundo fica borrado.

0:08 - 0:10: A montanha-russa atinge um trecho plano. O vento diminui e ambos fecham a boca, olhando completamente atordoados para a câmera.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2073315699271901184/img/3cJpEwkEHfbEhKHQ.jpg" width="600" alt="Vídeo de selfie de gato na montanha-russa">

**[🎬 Assistir vídeo →](https://x.com/michaelrabone/status/2073316066931966159)**

**Autor:** [Michael Rabone](https://x.com/michaelrabone) | **Fonte:** [Link](https://x.com/michaelrabone/status/2073316066931966159) | **Publicado:** Jul 4, 2026

---
### Mountain Bike em Floresta Alpina

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt de vídeo detalhado para uma sequência de 10 segundos de mountain bike através de uma floresta alpina, apresentando efeitos ambientais complexos e múltiplos ângulos de câmera.

#### 📝 Prompt

```
Duração: 10 segundos. Use a imagem de referência masculina anexada exatamente como está.

Uma floresta alpina após a chuva. O homem pedala uma mountain bike premium por uma trilha técnica na floresta. Água espirra das poças, a luz do sol atravessa as árvores, folhas se espalham sob os pneus e a suspensão comprime realisticamente sobre as rochas. Ele sai da floresta em direção a um mirante deslumbrante acima das montanhas e sorri discretamente.

A câmera alterna entre tomadas em FPV seguindo o ciclista, acompanhamento lateral baixo e um dramático afastamento de drone sobre o vale.

Trilha sonora: Orquestra híbrida inspiradora com percussão rítmica, sons realistas de bicicleta, movimento da corrente, pássaros e ambiente de floresta.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2073291490567372800/img/QeFefZQKKxyiSSgm.jpg" width="600" alt="Mountain Bike em Floresta Alpina">

**[🎬 Assistir vídeo →](https://x.com/vireonixx/status/2073291551653208142)**
...
<sub>🤖 Este README é gerado automaticamente. Última atualização: 2026-08-25T04:37:06.449Z</sub>
