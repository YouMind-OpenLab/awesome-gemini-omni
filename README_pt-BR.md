...
> Um prompt criativo para gerar um vídeo que lembra a tela de criação de personagens do The Sims, apresentando uma dança sutil, um Plumbob giratório e uma interface estática.

#### 📝 Prompt

```
Com base na minha foto, crie uma imagem no estilo do jogo The Sims, na tela de criação de personagem. Sim [homem] vestindo [calça jeans preta, camiseta preta e boné preto]. À direita do personagem, há quadrados brancos. Nesses quadrados, de cima para baixo: [MacBook, iPhone, AirPods Max]. Acima da cabeça do Sim, há um Plumbob verde e, acima dele, a inscrição [ALEX PROMPTS], feita no estilo do jogo The Sims. Adicione setas à direita e à esquerda do Sim, como no editor de personagens do The Sims. 9:16 Uma tela estilizada de criação de personagem do videogame The Sims. Um [homem] vestindo [camiseta preta, calça preta, boné preto] está no centro. Ele dança sutilmente no lugar, balançando os quadris e os braços suavemente. Acima de sua cabeça, um Plumbob verde flutua e gira lentamente. A interface do usuário com as opções de roupas, setas e o rótulo [ALEX PROMPTS] permanece completamente estática. O fundo não se move.
```
...
```
Timelapse cinematográfico ultrarrealista, progressão de luz natural do dia, desde a luz suave do amanhecer até o sol vibrante do meio-dia e o brilho quente do pôr do sol, câmera estática adaptável fixada em um canto elevado da sala de estar, mostrando todo o espaço com ajustes focais sutis para profundidade e paralaxe conforme a área se transforma. Movimentos realistas de trabalhadores, ferramentas, transportadores de móveis e materiais. Transformação de reforma de sala de estar. [00:00–00:01] Plano estático amplo de uma sala de estar datada dos anos 2000 sob a luz fria do amanhecer: carpete bege gasto, centro de entretenimento de madeira escura volumoso, papel de parede floral desbotado, sofá antigo, desordenado com decoração ultrapassada e iluminação fraca. Trabalhadores chegam com ferramentas e caixas. Efeitos sonoros: pássaros matinais, rangido de porta, ambiente leve. [00:01–00:03] Demolição e preparação rápidas: trabalhadores removem carpete antigo, papel de parede, móveis e acessórios em velocidade acelerada. Paredes são alisadas e pintadas, atualizações elétricas ocultas, novo contrapiso preparado. O sol nasce, as sombras mudam. Efeitos sonoros: rasgar carpete, raspar papel de parede, martelar, limpeza de detritos. [00:03–00:06] Instalação principal: prateleiras flutuantes e console de mídia em carvalho claro ou cinza modernos instalados, sofá grande em tons neutros posicionado, TV elegante montada, piso vinílico de luxo ou em espinha de peixe colocado, tapete de destaque desenrolado. Luz natural brilhante do meio-dia inunda o ambiente. Efeitos sonoros: furadeira, posicionamento de móveis, aspirador de pó, cliques de ferramentas. [00:06–00:08] Detalhes finais: iluminação moderna (luminárias de chão, embutidas, fitas de LED), almofadas, plantas, obras de arte e cortinas adicionadas. Mesa de centro com decoração se materializa. A luz dourada do fim da tarde cria reflexos quentes. Efeitos sonoros: sons de posicionamento mais suaves, tecido farfalhando, interruptores de luz. [00:08–00:10] Revelação final da sala de estar minimalista contemporânea concluída sob o calor do pôr do sol: brilhante, aconchegante, convidativa com linhas limpas, texturas em camadas, prateleiras abertas organizadas, iluminação ambiente suave, plantas frescas. Atmosfera calma e aspiracional. Comportamento da câmera: Câmera de timelapse estática adaptável — canto elevado fixo com leve reenquadramento inteligente e paralaxe para manter a visão completa e profundidade cinematográfica. Mudanças de perspectiva naturais, transições de material suaves. Humor e estética: Timelapse de reforma hiper-realista, mudança acelerada satisfatória de um ambiente datado e desordenado para um santuário moderno e brilhante. Ênfase em texturas (grão de madeira, tramas de tecido, acabamentos de pintura), iluminação natural dinâmica, progresso limpo e realização. Superfícies altamente detalhadas, física realista, movimentos orgânicos. Color grading cinematográfico, duração total de 10 segundos.
```
...
```
Faça o logotipo (Referência) surgir de forma estilizada em um fundo de tela verde. Centralizado no quadro. Ele aparece do nada, monta-se e então flutua no lugar. Efeito 3D incrível.
```
...
O quadro inicial mostra imediatamente o personagem já galopando em velocidade máxima por um enorme vale islandês em um poderoso cavalo preto. O cavalo atravessa um rio raso, sobe uma crista gramada sem diminuir a velocidade e, em seguida, corre ao longo da borda do penhasco com vista para cachoeiras e montanhas infinitas.
...
Trilha Sonora:
Orquestra celta épica, trompas francesas, coral, tambores taiko, cordas emocionantes.

Som Ambiental:
Cascos galopando, respingos de rio, movimento da sela de couro, vento, cachoeiras distantes, pássaros.
...
---
### Vlog aconchegante de organização de estante de livros

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt de vídeo detalhado para um vlog com estética de filmadora mini DV, apresentando uma jovem organizando livros com sons ASMR satisfatórios e iluminação natural.
...
ESTILO: Vlog aconchegante de organização de estante com elementos suaves de ASMR. Ritmo relaxado, diálogos mínimos, momentos espontâneos. Foco em sons satisfatórios: páginas virando, lombadas de livros batendo, pano tirando poeira, prateleiras se movendo suavemente.
...
→ (2s, plano zenital) Tira os livros da estante, organiza-os em pilhas.
→ (2s, close-up) Limpa a poeira da prateleira vazia com um pano.
→ (2s, plano portátil) Folheia um livro antigo, parando em uma página. "Esqueci que tinha este aqui."
→ (2s, plano de detalhe) Organiza os livros por cor, deslizando-os para o lugar. Sem diálogo.
→ (2s, plano médio) Adiciona uma pequena planta e uma vela à estante. "Só precisa de um pouco de decoração."
...
NOTAS DE ÁUDIO: Ambiente natural, virar de páginas, limpeza de poeira e deslizamento de livros devem estar claramente audíveis. Diálogo baixo e casual.
NOTAS DE REALISMO: Linguagem corporal autêntica, piscadas naturais, sorrisos genuínos, pausas ocasionais para pensar, enquadramento imperfeito, respiração de foco, mudanças de luz quente da tarde. Deve parecer um vlog pessoal genuíno de organização feito com uma filmadora doméstica, não uma produção comercial.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2077761124582543360/img/NROUVc0jpf1UZ9LZ.jpg" width="600" alt="Vlog aconchegante de organização de estante de livros">
...
---
### Revelação de Produto com Drone FPV em Desfiladeiro no Deserto

![English](https://img.shields.io/badge/lang-English-blue)

> Uma sequência cinematográfica de alta velocidade com drone FPV através de desfiladeiros acidentados no deserto, terminando com uma revelação nítida do produto em um planalto ensolarado.

#### 📝 Prompt

```
{
  "description": "Uma tomada cinematográfica de alta velocidade com drone FPV começa bem acima de dramáticos penhascos no deserto ao amanhecer. O drone mergulha abruptamente em desfiladeiros rochosos acidentados, passando rente às dunas de areia e correndo entre enormes paredes de pedra vermelha. O vento levanta rastros de poeira enquanto o drone acelera, passando por estreitos arcos naturais de rocha e cumes ensolarados. No meio do caminho, o movimento diminui gradualmente à medida que o drone emerge em um amplo planalto desértico, revelando uma única lata de Red Bull gelada sobre uma laje de pedra rústica, com a condensação visível e brilhando sob a luz da manhã. Sem texto.",
  "style": "cinematográfico, comercial de esportes radicais hiper-realista",
  "camera": "perspectiva de drone FPV em primeira pessoa com voo agressivo de alta velocidade pelo desfiladeiro, transicionando para uma revelação cinematográfica lenta, suave e controlada",
  "lighting": "luz do início do nascer do sol com destaques quentes, forte iluminação de contorno nas formações rochosas, sombras de alto contraste; reflexos nítidos e destaques de condensação na lata de Red Bull",
  "environment": "vasta paisagem de desfiladeiro no deserto com penhascos de pedra vermelha, cânions estreitos, dunas de areia, poeira soprada pelo vento e uma clareira em um planalto aberto",
  "motion": "movimento aéreo muito rápido com mergulhos acentuados, passagens próximas pelo desfiladeiro e curvas fechadas; transição gradual para câmera lenta e estabilização suave para a revelação final",
  ...
  "keywords": [
    ...
    "voo por desfiladeiro no deserto",
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2077736758104723456/img/Czy7V5pZUnqzGTlz.jpg" width="600" alt="Revelação de Produto com Drone FPV em Desfiladeiro no Deserto">
...
> Um prompt de edição de vídeo para vídeo para o Gemini Omni que modifica uma cena para incluir produtos da Chanel e uma suíte de hotel elegante, preservando a aparência do sujeito.

#### 📝 Prompt

```
Use o Gemini Omni, faça com que esta caixa que estou abrindo seja da Chanel; assim que eu abri-la, que haja perfumes da Chanel e alguns batons dentro.
...
> Um prompt cinematográfico detalhado para o Gemini Omni que cria um vídeo de suspense de 10 segundos de um pinguim bebê encontrado dentro de um baú de tesouro, incluindo instruções de áudio e câmera.

#### 📝 Prompt

```
Vídeo cinematográfico em POV de 10 segundos. Noite em uma floresta silenciosa. O feixe de uma lanterna varre lentamente o chão até descobrir um velho baú de tesouro de madeira coberto de musgo. A câmera se aproxima cuidadosamente com um movimento sutil de câmera na mão, criando suspense. Uma mão humana se abaixa, destranca o baú e levanta a tampa lentamente. Em vez de tesouro, um pequeno pinguim bebê fofo usando óculos escuros em miniatura está sentado lá dentro sobre cristais de gelo brilhantes. O pinguim olha diretamente para a câmera, sorri e levanta lentamente uma nadadeira para fazer um gesto claro de 👍 positivo. A câmera faz um zoom para um close-up da expressão adorável.

Áudio: Ambiente de floresta silenciosa com grilos distantes e uma música suave de suspense durante a aproximação. No instante em que o baú abre, a música muda para uma melodia alegre e inspiradora. Uma voz masculina adulta natural diz entusiasticamente: "Uau, maravilhoso!", perfeitamente sincronizada com o sinal de positivo do pinguim. O pinguim responde imediatamente com um som de pio fofo.

Ultrarrealista, iluminação cinematográfica, penas altamente detalhadas, olhos expressivos, física realista, animação natural, movimento de câmera na mão suave, profundidade de campo rasa, fotorrealista, sem legendas, sem texto, sem marca d'água.
```
...
> Um prompt abrangente de geração de vídeo para criar uma animação em stop-motion de 10 segundos usando o Gemini Omni. Segue uma sequência de storyboard sobre sobrecarga mental e um aplicativo de IA, apresentando uma estética artesanal de cartolina.

#### 📝 Prompt

```
Gere um vídeo único e contínuo de 10 segundos que anime a sequência de eventos mostrada na imagem de referência do storyboard fornecida. O vídeo deve progredir através do Quadro 1 (sobrecarga mental), Quadro 2 (check-in com um toque), Quadro 3 (assistente de IA) e Quadro 4 (branding), fazendo a transição suave entre cada cena com um ritmo ágil de stop-motion. DIRETRIZES DE ESTILO E MOVIMENTO Estética de stop-motion artesanal a 12 FPS com zero desfoque de movimento. Movimento ágil quadro a quadro com trepidação intencional de papel e reposicionamento visível de camadas. Materiais: Cartolina em camadas, bordas de jornal rasgado, fita adesiva e molduras Polaroid. Cores: Fundo off-white, preto carvão, destaques em amarelo elétrico e verde sálvia suave. SEQUÊNCIA DE CENAS (0-2,5s) Zoom macro rápido na cabeça de papel recortada de Isla caindo em uma bagunça caótica de papéis. A tipografia "MIND WON'T SLOW DOWN?" aparece palavra por palavra. (2,5-5s) Uma placa limpa desliza para dentro. Isla sorri de uma moldura Polaroid. Um dedo de papel toca um telefone de papel, substituindo a bagunça por flores de papel e luz do sol. (5-8s) O boneco articulado de Isla caminha sobre pedras. Cartões de IA se desenrolam em estilo sanfona: "Breathe", "Reflect", "Reset". (8-10s) Um smartphone de papel surge no centro mostrando a interface do Feel Fresh. O logotipo "FEEL FRESH" é carimbado com um zoom final. ÁUDIO "Já sentiu que sua mente simplesmente não desacelera? Com o Feel Fresh, faça um check-in com apenas um toque. Deixe a IA ajudar você a respirar, refletir e recomeçar. Feel Fresh, sinta-se mais leve, todos os dias."
```
...
```
Samurai futurista com pele de ônix, vestes opulentas e uma máscara Oni holográfica brilhante com runas em LED. Ação cinematográfica, estética cyberpunk, fundo com bokeh neon brilhante, resolução 8k, fotorrealista.

Linha do Tempo de Ação de 10 Segundos:

0-2s: A máscara de LED e as runas holográficas ligam e piscam.

2-4s: Zoom rápido para trás. O samurai saca rapidamente uma katana que estala com energia neon brilhante.

4-7s: Avanço rápido. O samurai executa um golpe luminoso e amplo em direção à câmera.

7-10s: Finalização em câmera lenta. O samurai embainha a katana enquanto uma chuva neon começa a cair, mantendo uma pose estoica.
```
...
> Um prompt de vídeo cinematográfico altamente detalhado para o Gemini Omni, criando uma sequência de road movie de cinco tomadas com iluminação de golden hour e detalhes consistentes da personagem.
...
Use a imagem de referência feminina fornecida como protagonista. Preserve a identidade facial exata, penteado, tom de pele, proporções corporais, continuidade das roupas e expressões ao longo de toda a sequência.
...
Ela nota uma pequena placa de madeira onde se lê:

**"Scenic Route."**

Ela sorri e faz a curva.

### TOMADA 3 (0:04–0:06)

A estrada sobe acima da linha costeira, revelando uma vista panorâmica de tirar o fôlego do oceano.
...
Uma tomada ampla de drone a mostra sozinha no penhasco enquanto as ondas quebram abaixo.
...
```
a câmera orbita lentamente o produto, reflexos se movem pela superfície, partículas suaves no ar, sensação de anúncio premium
```
...
---
### Retrato Cinematográfico de Mulher Ruiva em Filme

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt preciso baseado em linha do tempo para um vídeo cinematográfico de 10 segundos apresentando uma mulher ruiva, utilizando estética específica de filme de médio formato e transições de iluminação.
...
3-5s: O vento intensifica. O cabelo chicoteia dinamicamente pelo rosto. A granulação do filme analógico e os vazamentos de luz pulsam.
...
8-10s: O vento diminui ligeiramente. Um vazamento de luz quente final desaparece enquanto ela permanece imóvel e serena.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2073723425554620416/img/5mw8vqRT0YwDv71P.jpg" width="600" alt="Retrato Cinematográfico de Mulher Ruiva em Filme">
...
```
Use a imagem anexada como única referência. Não altere a ilustração, personagem, design, cores, formas, proporções ou detalhes da imagem de referência. Use sempre a mesma imagem, animando apenas sua posição, escala, rotação, rotação 3D e duplicação. Não gere nem redesenhe novas ilustrações. 16:9, 10 segundos, motion graphics de alta qualidade. Fundo simples e limpo. Design de movimento sofisticado com qualidade comercial, como se produzido no After Effects.

No início do vídeo, a imagem anexada aparece no centro da tela. A imagem aumenta de escala rapidamente e, em seguida, repete ritmicamente o zoom in e zoom out. A animação de escala salta vigorosamente com um tempo que acompanha uma batida musical.

Em seguida, a imagem continua a aumentar ligeiramente enquanto gira 360 graus em alta velocidade ao redor do seu centro. Ela então transita suavemente para uma rotação 3D no eixo Y (giro de cartão), com a câmera movendo-se levemente para frente e para trás para criar profundidade.
...
No final, todas as 16 imagens são sugadas para o centro em alta velocidade e fundidas em uma só. A câmera dá um zoom poderoso em direção à imagem fundida, terminando o vídeo com um desfecho impactante.

Mantenha um desenvolvimento energético e bem ritmado, sem pausas durante todo o vídeo. A animação deve ser suave e nítida, alcançando motion graphics de alta qualidade adequados para comerciais, videoclipes ou anúncios no YouTube.
...
2-4 segundos: 'Girigiri' (Por pouco) desliza para a esquerda e direita em alta velocidade com desfoque de movimento.
4-6 segundos: Sincronizado com a rotação 3D, 'Shueki' (Receita) salta do fundo e aumenta significativamente de escala.
6-8 segundos: Quando a imagem se divide em 4 e 16, múltiplos ícones de 'X' aparecem e se espalham ritmicamente pela tela.
...
> Um prompt bem-humorado em estilo POV retratando um homem e seu gato andando em uma montanha-russa, completo com uma linha do tempo detalhada de 10 segundos de suas reações.

#### 📝 Prompt

```
Vídeo divertido em estilo selfie de um homem barbudo gritando enquanto segura seu gato malhado laranja em uma montanha-russa rápida. Ambos estão com olhos arregalados e bocas abertas em um terror sincronizado. Efeitos de vento forte, trilhos azuis sinuosos e um fundo de céu nublado passando em alta velocidade.
...
---
### Mountain Biking em Floresta Alpina

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt de vídeo detalhado para uma sequência de 10 segundos de mountain bike em uma floresta alpina, apresentando efeitos ambientais complexos e múltiplos ângulos de câmera.

#### 📝 Prompt

```
Duração: 10 segundos. Use a imagem de referência masculina em anexo exatamente como está.

Uma floresta alpina após a chuva. O homem pedala uma mountain bike premium por uma trilha técnica na floresta. Água espirra das poças, a luz do sol atravessa as árvores, folhas se espalham sob os pneus e a suspensão comprime realisticamente sobre as pedras. Ele sai da floresta em direção a um mirante de tirar o fôlego acima das montanhas e sorri discretamente.

A câmera alterna entre tomadas de acompanhamento em FPV, acompanhamento lateral baixo e um dramático afastamento de drone sobre o vale.
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2073291490567372800/img/QeFefZQKKxyiSSgm.jpg" width="600" alt="Mountain Biking em Floresta Alpina">
...
A câmera se move ao redor do ombro dela para revelar a pintura. Ela simplesmente permanece ali, apreciando-a. Nada mais acontece. O silêncio se torna a história.
...
```
Assunto principal: jovem japonesa, na casa dos 20 anos, aparência natural do dia a dia, cardigã de tricô creme oversized, camiseta azul-marinho desbotada, calça cargo bege larga, tênis de lona branco, colar de prata fino, cabelo preto liso preso de forma despojada com uma pequena presilha de casco de tartaruga. Textura de pele realista, maquiagem mínima, sorriso calmo e tímido, personalidade suave, porém curiosa. Mantenha a identidade, as roupas, o penteado e a aparência consistentes durante todo o vídeo.

Localização: Rua residencial tranquila e autêntica de Tóquio durante uma leve chuva no final da manhã. Ruas estreitas de asfalto, casas compactas, pequenas varandas, calhas, bicicletas com capas de plástico, vasos de plantas, guarda-chuvas perto das portas, postes de luz, fios aéreos, máquinas de venda automática apenas ao fundo sem anúncios legíveis, reflexos no pavimento molhado, sensação de bairro pacífico. Sem multidões, sem atividade comercial, sem foco em sinalização moderna.
...
Estilo de Câmera: Estética de filmadora DV de consumo do início dos anos 2000. Um amigo gravando momentos cotidianos casualmente. Trepidação intensa de câmera na mão, enquadramento imperfeito, busca frequente de foco automático, respiração da lente, oscilação de exposição devido aos reflexos do céu cinzento, leve desfoque de movimento, rolling shutter sutil, artefatos de compressão digital leves, cores desbotadas, contraste suave, leve ruído de sensor. Sem estabilização. Sem movimentos de câmera cinematográficos. Sem correção de cor moderna.

00:00–00:02
Do lado de fora da entrada de um pequeno apartamento. Ela sai segurando um guarda-chuva transparente, verifica a chuva com a palma da mão e depois sorri para a câmera. O foco se desvia brevemente para as gotas de chuva no guarda-chuva.
...
00:08–00:10
Ela fica sob um pequeno toldo com um café enlatado quente. O vapor é tênue na chuva fria. A câmera desvia para baixo demais e corrige com atraso.

00:10–00:12
Ângulo lateral próximo. Alguém fora da câmera diz bom dia. Ela se vira, levanta o guarda-chuva levemente, sorri e diz casualmente: “Ohayou”. A câmera captura o sorriso com um leve atraso.
...
---
### Vídeo documental autêntico de Lisboa estilo filmadora

![English](https://img.shields.io/badge/lang-English-blue)

> Um prompt altamente detalhado e estruturado para gerar uma cena estilo vídeo caseiro do início dos anos 2000 em Lisboa, usando o Gemini Omni Flash.

#### 📝 Prompt

```
Assunto principal: jovem portuguesa, na casa dos 20 anos, aparência natural do dia a dia, regata justa amarelo-claro, calça jeans azul de cintura alta, sandálias de couro marrom gastas, brincos pequenos de argola dourada, cabelo castanho ondulado preso em um coque baixo despojado com mechas soltas. Textura de pele realista, sardas leves, maquiagem mínima, personalidade viva e descontraída. Mantenha a identidade, as roupas, o penteado e a aparência consistentes durante todo o vídeo.

Localização: Rua residencial autêntica em uma colina de Lisboa durante uma manhã quente. Ruas estreitas de paralelepípedos, fachadas de apartamentos com azulejos, pequenas varandas de ferro, roupas estendidas entre as janelas, portas desbotadas, vasos de manjericão e flores, escadarias íngremes, scooters antigas, paredes iluminadas pelo sol, atmosfera de bairro tranquilo. Sem multidões de turistas, sem lojas, sem anúncios, sem cafés.
...
Estilo de Câmera: Estética de filmadora DV de consumo do início dos anos 2000. Um amigo gravando casualmente momentos do dia a dia. Muita trepidação de câmera na mão, enquadramento imperfeito, busca frequente de foco automático, respiração da lente, oscilação de exposição entre azulejos iluminados pelo sol e degraus sombreados, desfoque de movimento ocasional, leve efeito de rolling shutter, artefatos sutis de compressão digital, cores desbotadas, contraste suave, leve ruído de sensor. Sem estabilização. Sem movimentos de câmera cinematográficos. Sem tratamento de cor moderno.
...
00:02–00:04
A câmera a acompanha enquanto ela desce as escadas para a rua de paralelepípedos. Ela carrega uma pequena cesta de vime e verifica as roupas estendidas do lado de fora de uma janela.

00:04–00:06
Ela encontra uma meia caída nos degraus, ri e a prende de volta no varal. O foco automático alterna entre seu rosto e os prendedores de roupa.
...
00:08–00:10
Ela se senta em um degrau baixo de pedra com uma pequena xícara de café expresso. A luz do sol tremeluz sobre os azulejos estampados atrás dela. A exposição pulsa conforme a câmera se inclina para cima.
...
Áudio: Apenas som ambiente natural, scooters distantes, pombos, passos no paralelepípedo, tecido movendo-se nos varais, vozes suaves do bairro, água pingando das plantas, vento leve. Sem música. Sem design de som. Sem narração.
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2072753893600038912/img/BngLHIuefeWAWkk_.jpg" width="600" alt="Vídeo documental autêntico de Lisboa estilo filmadora">
...
<sub>🤖 Este README é gerado automaticamente. Última atualização: 2026-08-23T16:22:38.992Z</sub>
