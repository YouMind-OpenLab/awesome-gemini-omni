...
# 🎬 Harika Gemini Omni Video İstemleri
...
Google Gemini Omni için yüksek kaliteli video oluşturma istemleri koleksiyonu

> ⚠️ **Telif Hakkı Bildirimi**: Tüm istemler eğitim amaçlı olarak topluluktan toplanmıştır. Herhangi bir içeriğin haklarınızı ihlal ettiğini düşünüyorsanız, lütfen [bir sorun açın](https://github.com/YouMind-OpenLab/awesome-gemini-omni/issues/new) ve derhal kaldıralım.
...
**Gemini Omni**, **Google** tarafından geliştirilen bir video oluşturma modelidir. Endüstrinin **eş zamanlı dört-modlu giriş** destekleyen ilk modeli — görüntü, video, ses ve metin.
...
---
### GTA Hindistan Fragman Oluşturucu

![English](https://img.shields.io/badge/lang-English-blue)

> Tac Mahal gibi Hindistan'ın kültürel simgelerini içeren oyun tarzında bir fragman oluşturmak için basit bir komut.

#### 📝 İstem

```
bir GTA Hindistan fragmanı oluştur
```

<img src="https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/a265c8597d79084a16e32ad30792f572/thumbnails/thumbnail.jpg" width="600" alt="GTA Hindistan Fragman Oluşturucu">

**[🎬 Videoyu izle →](https://x.com/BuildFastWithAI/status/2059522490876010600)**

**Yazar:** [Build Fast with AI](https://x.com/BuildFastWithAI) | **Kaynak:** [Link](https://x.com/BuildFastWithAI/status/2059522490876010600) | **Yayınlandı:** May 27, 2026

---
### Sinematik Seyahat Anıları Haritası

![English](https://img.shields.io/badge/lang-English-blue)

> Açılan bir harita ve varış noktası biletinin yer aldığı kısa bir seyahat filmi oluşturmak için detaylı sinematik komut.

#### 📝 İstem

```
[CITY] = TOKYO
[CITY] için 10 saniyelik sinematik bir seyahat anısı filmi oluşturun.
Temiz, fildişi rengi bir masanın üzerinde katlanmış bir kağıt harita ve eski bir seyahat bileti duruyor.
Biletin üzerinde varış noktası olarak “[CITY]” yazıyor.
...
---
### Hızlı Logo Animasyon Asistanı

![English](https://img.shields.io/badge/lang-English-blue)

> Tasarımı merkezde tutarak basit bir logonun 20 farklı versiyonunu sergileyen yüksek hızlı bir animasyon oluşturmaya yönelik bir komut.
...
<sub>🤖 Bu README otomatik olarak oluşturulmuştur. Son güncelleme: 2026-07-02T21:05:12.843Z</sub>
