...
> 使用三張參考圖片，製作一段節奏明快的 5 秒 2D 中式動漫角色介紹剪輯，呈現獨特的水墨專案與英雄姿態。

#### 📝 提示詞

```
請使用提供的三張參考圖片，製作一段節奏明快的 5 秒 2D 中式動漫（國漫）角色介紹剪輯。重要提示：@Image1、@Image2 與 @Image3 是三位完全不同的角色。請務必保留每位角色在參考圖中的臉部特徵、髮型、膚色、服裝、體型及配件。切勿合併、變形、融合或替換其身份。每次畫面僅顯示一位角色。背景設定：每位角色需搭配獨特的水墨色塊（靛藍色 / 朱砂紅 / 松綠色），並伴隨飛舞的筆觸粒子，角落需蓋上名章。CUT 01 | 0.0-1.6s - @Image1 以快速橫移模糊效果切入，呈現英雄姿態，臉部佔畫面高度 40%，背景為靛藍色水墨塊，右上角蓋上名章。CUT 02 | 1.6-3.2s - 硬切。@Image2 沿對角線速度線滑入，背景為朱砂紅水墨塊，左側蓋上名章。CUT 03 | 3.2-5.0s - 硬切。@Image3 從上方落下，帶有衝擊幀與畫面震動效果，背景為松綠色水墨塊；三枚名章於底部對齊；定格於最後一幀。攝影：僅使用快速推鏡。禁止使用遠景全身鏡頭；臉部需維持在畫面高度的 35-50%。音效：三次太鼓風格打擊聲 + 每次切換時的水墨噴濺音效。禁止：身份變形、單一畫面出現兩位角色、重新設計服裝、美式漫畫風格、除名章外任何可讀文字。中式動漫（國漫）風格角色設定圖，19 歲年輕劍客的半身英雄肖像，眼神銳利自信，墨黑色長髮高束並配有銀色髮簪，深靛藍色多層長袍，繡有淡淡雲紋，領口佩戴一塊玉佩，嘴角微揚，臉部佔畫面約 40%，賽璐珞渲染並帶有細膩水墨質感，線條乾淨俐落，電影級角色設計，純暖淺灰色背景，柔和均勻光照 --ar 3:4 --v 7 --s 150 --no text, watermark, logo, signature, border 中式動漫（國漫）風格角色設定圖，17 歲俏皮少女的半身英雄肖像，琥珀色明眸，雙丸子頭配朱砂紅絲帶及兩側垂落髮絲，紅白色短款武術外套配金邊，手持半開摺扇靠近下巴，調皮笑容，臉部佔畫面約 40%，賽璐珞渲染並帶有細膩水墨質感，線條乾淨俐落，電影級角色設計，純暖淺灰色背景，柔和均勻光照 --ar 3:4 --v 7 --s 150 --no text, watermark, logo, signature, border 中式動漫（國漫）風格角色設定圖，35 歲溫和巨漢武僧的半身英雄肖像，寬肩，光頭帶有淡淡鬍渣，濃眉，溫暖誠懇的笑容，松綠色僧袍且露出一側肩膀，頸部佩戴木質佛珠，左眉處有小傷疤，臉部佔畫面約 40%，賽璐珞渲染並帶有細膩水墨質感，線條乾淨俐落，電影級角色設計，純暖淺灰色背景，柔和均勻光照 --ar 3:4 --v 7 --s 150 --no text, watermark, logo, signature, border
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2090179877815128065/img/T9QKihnEdChkgmZM.jpg" width="600" alt="中式動漫角色介紹">

**[🎬 觀看視頻 →](https://x.com/EZheng66099/status/2090180685902369163)**

**作者:** [EZ](https://x.com/EZheng66099) | **來源:** [Link](https://x.com/EZheng66099/status/2090180685902369163) | **發布時間:** Aug 19, 2026
...
<sub>🤖 此 README 自動生成。最後更新： 2026-08-20T20:26:02.276Z</sub>
