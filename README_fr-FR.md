...
# 🎬 Prompts Vidéo Gemini Omni Géniaux
...
Une collection de prompts de génération vidéo de haute qualité pour Gemini Omni de Google

> ⚠️ **Avis de droit d'auteur**: Tous les prompts sont collectés auprès de la communauté à des fins éducatives. Si vous pensez qu'un contenu enfreint vos droits, veuillez [ouvrir un problème](https://github.com/YouMind-OpenLab/awesome-gemini-omni/issues/new) et nous le supprimerons rapidement.

---

## 📖 Table des matières

- [🤔 Qu'est-ce que Gemini Omni ?](#-quest-ce-que-gemini-omni-)
...
**Gemini Omni** est un modèle de génération vidéo développé par **Google**. C'est le premier modèle de l'industrie à prendre en charge **l'entrée quadri-modale simultanée** — image, vidéo, audio et texte.
...
### Prompt Vidéo Gemini Omni : Poésie Ancienne Chinoise

![中文](https://img.shields.io/badge/lang-中文-red)

> Prompt détaillé en plusieurs parties pour générer une vidéo d'animation verticale au format 9:16, dans le style de l'encre et du lavis chinois anciens, basée sur le poème « Adieu à un ami » de Li Bai. Il spécifie la génération texte-vers-vidéo sans audio, sous-titres ou superpositions textuelles, mettant l'accent sur la narration visuelle d'une scène d'adieu.

#### 📝 Prompt

```
## Paramètres de Génération Unifiés

- Mode : Texte-vers-Vidéo Pur
- Ne pas téléverser de vidéos de référence
- Ne pas téléverser d'images de référence
- Ne pas téléverser de voix off ni aucun audio
- Ratio d'aspect : Vertical 9:16
- Durée suggérée : 10 secondes par segment
- Sortie : Visuels uniquement, silencieux
- Post-production : La narration Doubao originale et les sous-titres seront réajoutés localement
- Priorité Absolue : Aucun texte, sous-titre, titre, calligraphie, sceau, inscription sur plaque, filigrane, logo, interface utilisateur, pseudo-caractères, code illisible, anglais ou chiffres ne doit apparaître de la première à la dernière image.

---

## Partie 1 | Ouverture « Adieu à un ami » : L'Adieu Hors des Murs de la Ville

Générer une animation chinoise ancienne verticale de 10 secondes au format 9:16.

Hors des murs de la ville de la dynastie Tang, une scène d'adieu dans un paysage ouvert. Des montagnes vertes lointaines et continues s'étendent à l'horizon ; à proximité, des rivières claires serpentent autour de la cité antique. Les remparts, les berges, les routes anciennes et les montagnes lointaines créent une profondeur distincte.

Il y a deux lettrés de la dynastie Tang, âgés d'une trentaine d'années, dans la scène.

Li Bai : Un visage masculin est-asiatique fin et naturel, cheveux noirs attachés, portant une longue robe croisée bleu-gris avec une doublure blanc cassé, des chaussures en tissu, possédant un tempérament libre et calme.

L'Ami : Un homme est-asiatique d'une trentaine d'années, portant une longue robe croisée brune simple, cheveux noirs attachés, transportant un sac de voyage simple, accompagné d'un cheval brun.

La caméra commence par une vue large des montagnes vertes, des rivières et des remparts, avançant lentement. Les deux lettrés marchent côte à côte le long de la route ancienne près de la berge, sur le point de se séparer. Une brise fait bouger leurs manches, les feuilles et les crins du cheval ; de subtiles ondulations apparaissent à la surface de la rivière.

Ensuite, les deux s'arrêtent près de la route ancienne, le chemin s'étendant vers les montagnes au loin, créant une atmosphère de départ alors que l'ami est sur le point de voyager loin. L'émotion globale n'est pas le chagrin, mais implicite, retenue et libre, avec une réticence sous-jacente à se quitter.

Style d'animation classique au lavis coloré chinois, paysages cyan-vert pâles, texture délicate de papier de riz, composition cinématographique, éclairage et ombres naturels, proportions réalistes des personnages, mouvements naturels et retenus, travail de caméra stable et lent. Doit maintenir le cadre complet 9:16 sans couper la tête des personnages ou des éléments importants du paysage.

Animation purement visuelle. Pas de voix off. Les personnages ne parlent pas. Pas de synchronisation labiale. Pas de musique. Pas de son ambiant. Pas d'effets sonores.

Absolument interdit tout au long : Toute apparition de texte. Pas de sous-titres, titres, poèmes, noms d'auteurs, calligraphies, sceaux, inscriptions sur plaques, textes sur drapeaux, rouleaux, inscriptions sur stèles, filigranes, logos, interfaces, pseudo-caractères, codes illisibles, anglais ou chiffres. Les plaques sur les bâtiments doivent être vierges ou complètement absentes. Maintenir un écran pur sans texte de la première à la dernière image.

---

## Partie 2 | Montagnes Vertes et Eaux Blanches

Générer une animation chinoise ancienne verticale de 10 secondes au format 9:16.

Continuer l'univers visuel de l'adieu hors des murs de la ville Tang.

L'ouverture est une vue grandiose des montagnes vertes, de la cité antique et des rivières. Les montagnes vertes s'étendent horizontalement au nord de la cité antique, avec des pentes étalées, des sommets superposés et de légers nuages se déplaçant lentement parmi les montagnes.

La caméra effectue un panoramique régulier, révélant progressivement une rivière claire serpentant du côté est de la cité antique. L'eau de la rivière est brillante et propre, reflétant le ciel, les remparts et les montagnes lointaines, avec seulement de légères ondulations à la surface.

Près de la route ancienne sur la berge, les deux lettrés de la dynastie Tang apparaissent dans le cadre à une échelle plus petite. Li Bai porte une longue robe croisée bleu-gris, l'ami porte une longue robe brune simple, accompagné d'un cheval brun.

Les personnages restent silencieux, ne parlant pas, exprimant la situation de la séparation imminente uniquement en s'arrêtant pour contempler le paysage.

Dans la seconde moitié, la caméra se déplace lentement le long de la rivière, permettant aux montagnes vertes, aux eaux blanches, à la cité antique et à la route ancienne de former une composition complète de paysage chinois.

Style au lavis coloré chinois cyan-vert pâle, texture délicate de papier de riz, couches spatiales réalistes, sensation cinématographique, mouvement lent et régulier, pas de transitions rapides.

Visuels purs. Pas de voix off, pas de musique, pas de son ambiant, pas d'effets sonores. Les personnages ne parlent pas et n'effectuent pas de synchronisation labiale de lecture.

L'écran doit être 100 % sans texte. Pas de sous-titres, pas de poèmes, pas de calligraphie, pas de titres, pas d'inscriptions sur plaques, pas de sceaux, pas de rouleaux, pas d'inscriptions sur stèles, pas de filigranes, pas de logos, pas de pseudo-caractères ou de codes illisibles. Toute architecture ou objet où du texte pourrait apparaître doit rester complètement vierge.

---

## Partie 3 | Ici Nous Nous Quittons, Solitaire Herbe Rouleuse Voyageant Loin

Générer une animation d'adieu de style ancien de la dynastie Tang verticale de 10 secondes au format 9:16.

Près de la route ancienne sur la berge, deux lettrés de la dynastie Tang d'une trentaine d'années se font face.

Li Bai maintient sa longue robe croisée bleu-gris, ses cheveux noirs attachés et son visage fin et naturel. L'ami partant maintient sa longue robe brune simple, ses cheveux noirs attachés, accompagné d'un cheval brun portant seulement un sac de voyage simple sur le dos.

Au début, les deux se regardent silencieusement près de la route ancienne. Ensuite, ils se disent adieu avec des saluts retenus mains jointes, hochant doucement la tête, sans étreinte, pleurs ou jeu exagéré.

L'ami se retourne, menant le cheval vers la route ancienne lointaine. La caméra recule progressivement.

La route ancienne s'étend profondément dans les montagnes. Une herbe rouloire propre et naturelle est poussée par le vent, roulant ou oscillant légèrement dans la nature sauvage, utilisant le paysage naturel pour impliquer la dérive et le voyage loin. Ne pas transformer le personnage en herbe rouloire ; ne pas utiliser de magie ou d'effets spéciaux fantastiques.

Dans la seconde moitié, se concentrer sur les dos de l'ami et du cheval disparaissant progressivement, tandis que Li Bai reste plus proche, les regardant partir. Les terres sauvages montagneuses sont vastes, et les figures deviennent plus petites, renforçant le sentiment d'espace pour un voyage de dix mille li.

Animation classique au lavis coloré chinois, tons cyan-vert pâles et bruns terreux, texture de papier de riz, composition cinématographique, proportions réalistes des personnages, manches et crins de cheval flottant légèrement dans le vent, mouvement de caméra lent et naturel.

Visuels purs, pas de son. Les personnages ne parlent pas et ne font pas de synchronisation labiale.

Ne jamais générer aucun texte. Interdit : Sous-titres, poèmes, titres, calligraphies, sceaux, inscriptions sur plaques, textes sur drapeaux, rouleaux, inscriptions sur stèles, logos, filigranes, anglais, chiffres, pseudo-textes et codes illisibles.

---

## Partie 4 | Nuages Flottants pour le Voyageur, Soleil Couchant pour le Vieil Ami

Générer une animation au lavis de style ancien chinois verticale de 10 secondes au format 9:16.

La route ancienne hors des murs de la ville Tang s'étend au loin. L'ami a déjà monté ou mené le cheval lentement le long de la route ancienne.

Plusieurs nuages flottants se déplacent lentement dans le ciel. La caméra monte d'abord doucement, suivant les nuages dérivants dans le ciel, puis descend lentement pour se connecter avec le dos de l'ami partant, créant un écho visuel naturel entre les nuages flottants et le voyageur.

Ne pas utiliser de texte ou de symboles abstraits pour expliquer cette conception artistique ; exprimer cela uniquement par l'imagerie.

Ensuite, la caméra regarde en arrière lentement. Li Bai se tient seul près de la route ancienne sur la berge, portant une longue robe bleu-gris, regardant silencieusement son ami disparaître au loin.

Le soleil couchant à l'ouest s'enfonce lentement. Une lumière douce de coucher de soleil doré illumine le profil de Li Bai, la surface de la rivière et les montagnes lointaines.

L'expression de Li Bai est calme mais réticente, sans larmes, et sans expressions tristes exagérées.

Finalement, une image complète se forme : les nuages flottants dans le ciel, l'ami lointain, le soleil couchant, la rivière et Li Bai restant derrière pour regarder existent simultanément dans un espace paysager stratifié.

Style au lavis coloré chinois, combinant cyan-vert pâle avec une lueur chaude de coucher de soleil, texture de papier de riz, éclairage et ombres naturels réalistes, sensation cinématographique, mouvement de caméra lent et fluide, actions implicites et retenues.

Visuels purs. Pas de voix off, pas de musique, pas de son ambiant, pas d'effets sonores. Les personnages ne parlent pas et ne font pas de synchronisation labiale.

Absolument aucun texte tout au long de la vidéo. Pas de sous-titres, pas de poèmes, pas de titres, pas de calligraphie, pas d'inscriptions sur plaques, pas de sceaux, pas de rouleaux, pas de logos, pas de filigranes, pas de pseudo-caractères, pas de codes illisibles.

---

## Partie 5 | Saluant l'Adieu, Hennissement Long du Cheval

Générer une animation d'adieu de style ancien de la dynastie Tang verticale de 10 secondes au format 9:16.

La route ancienne hors de la ville sous le soleil couchant.

Li Bai porte une longue robe croisée bleu-gris, se tenant près de la route ancienne sur la berge. L'ami porte une longue robe brune simple et a déjà monté ou mené le cheval brun à une certaine distance.

Au début, l'ami se retourne. Li Bai lève la main pour saluer son ami ; l'ami lointain se retourne également et fait signe en réponse. Les mouvements sont lents, naturels et retenus.

Ensuite, l'ami continue de marcher vers le loin.

Le cheval brun tourne brièvement la tête en arrière, levant doucement la tête, crins flottant dans le vent, exprimant le sentiment de réticence à quitter le troupeau par les actions du cheval.

Ici, montrer uniquement les actions visuelles du cheval. Ne pas générer de sons de hennissement, d'ondes sonores ou de texte onomatopéique.

La caméra recule progressivement. L'ami et le cheval s'éloignent de plus en plus le long de la route ancienne, tandis que Li Bai reste en place à regarder. Le soleil couchant, les montagnes lointaines, la rivière, la route ancienne et les deux amis se séparant graduellement forment la scène finale d'adieu.

Pour les deux dernières secondes, garder la scène complète, avec seulement de légers mouvements de la lumière du coucher de soleil, des manches, des feuilles et des crins du cheval.

Pas d'écran noir. Pas de fondu au noir pour finir. Ne pas générer de rouleaux ou d'écran de fin avec du texte.

Animation classique au lavis coloré chinois, paysages cyan-vert pâles combinés avec une lueur chaude de coucher de soleil, texture délicate de papier de riz, composition cinématographique, proportions réalistes des personnages, mouvement de caméra régulier et lent.

Visuels purs, complètement silencieux. Pas de voix off. Pas de musique. Pas de son ambiant. Pas d'effets sonores. Les personnages ne parlent pas et ne font pas de synchronisation labiale.

De la première à la dernière image, il ne doit absolument y avoir aucun texte. Interdit : Sous-titres, poèmes, titres, noms d'auteurs, calligraphies, sceaux, inscriptions sur plaques, textes sur drapeaux, inscriptions sur stèles, textes sur rouleaux, logos, filigranes, interfaces, chiffres, anglais, pseudo-caractères et codes illisibles.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2102676626068930560/img/Twk6W56KBSf8MFLa.jpg" width="600" alt="Prompt Vidéo Gemini Omni : Poésie Ancienne Chinoise">

**[🎬 Voir la vidéo →](https://x.com/7998l201/status/2102676845212709346)**

**Auteur:** [Ryan](https://x.com/7998l201) | **Source:** [Link](https://x.com/7998l201/status/2102676845212709346) | **Publié:** Sep 23, 2026

---
### Prompt vidéo publicitaire d'entreprise avec Gemini Omni

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt détaillé pour générer une vidéo publicitaire d'entreprise photoréaliste de 10 secondes avec Gemini Omni, basée sur un storyboard fourni.

#### 📝 Prompt

```
Créez une publicité vidéo d'entreprise japonaise photoréaliste haut de gamme d'une durée exacte de 10 secondes pour la société fictive d'architecture et de construction « NEXARC CONSTRUCTION ».

TABLEAU DE RÉFÉRENCE
Le storyboard 3×3 téléversé contrôle la composition des plans, les angles de caméra, le positionnement des sujets et les transitions de scène. Veillez à respecter strictement la narration visuelle présentée dans les images de référence.
```

<img src="https://cms-assets.youmind.com/media/1790153039061_9sfv6o_HS0AkODa8AAhHja.jpg" width="600" alt="Prompt vidéo publicitaire d'entreprise avec Gemini Omni">

**[🎬 Voir la vidéo →](https://x.com/husky__create/status/2102337252340994249)**

**Auteur:** [はすきー｜Midjourneyマニア🐺](https://x.com/husky__create) | **Source:** [Link](https://x.com/husky__create/status/2102337252340994249) | **Publié:** Sep 22, 2026

---
### Prompt vidéo de cuisine Khachapuri avec Gemini Omni

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt détaillé pour générer une vidéo photoréaliste de 10 secondes montrant la préparation du khachapuri, avec des instructions strictes sur la continuité et le cadrage.

#### 📝 Prompt

```
Créez une vidéo photoréaliste de 10 secondes au format 16:9 montrant la préparation du khachapuri, exactement dans l'ordre chronologique. Caméra statique à 90° en vue de dessus (top-down), table noir mat, mêmes mains masculines portant des gants noirs, coupes franches uniquement, pas de magie ni d'étapes sautées : 0,0-0,7 ingrédients disposés symétriquement, les mains prennent la pâte -> 0,7-1,5 étaler la pâte en forme ovale -> 1,5-2,2 rouler les bords longs vers l'intérieur -> 2,2-2,8 pincer les deux extrémités pour former une barque -> 2,8-3,6 remplir uniformément avec du fromage râpé -> 3,6-4,2 placer le khachapuri cru sur une plaque de cuisson noire -> 4,2-5,0 glisser visiblement le khachapuri cru dans le four -> 5,0-5,8 timelapse rapide et réaliste à l'intérieur du four : la pâte gonfle et devient dorée, le fromage fond et bouillonne -> 5,8-6,5 les mains retirent le khachapuri cuit -> 6,5-7,3 casser un œuf directement au centre -> 7,3-8,0 remettre au four, court timelapse : le blanc d'œuf se fige légèrement tandis que le jaune reste coulant -> 8,0-8,6 retirer le khachapuri terminé et le poser sur la table noire -> 8,6-9,2 ajouter des cubes de beurre à côté du jaune, le beurre commence à fondre -> 9,2-10,0 les mains sortent du cadre, plan héroïque du khachapuri doré avec fromage fondu, jaune d'œuf brillant et coulant, et beurre qui fond. Chaque plan suivant doit continuer exactement depuis l'état précédent de la nourriture ; mouvements de mains rapides, précis et réalistes, aucun mouvement de caméra, pas de lévitation, de téléportation, de cuisson instantanée, d'ingrédients disparaissant ou dupliqués.
```

<img src="https://cms-assets.youmind.com/media/1790153036963_wt5ej4_HSxFJWAW4AAusdb.jpg" width="600" alt="Prompt vidéo de cuisine Khachapuri avec Gemini Omni">

**[🎬 Voir la vidéo →](https://x.com/999shinobi/status/2102142574848798798)**

**Auteur:** [999](https://x.com/999shinobi) | **Source:** [Link](https://x.com/999shinobi/status/2102142574848798798) | **Publié:** Sep 21, 2026
...
> Un prompt pour créer une vidéo courte destinée à la campagne caritative Heart Action, utilisant une esthétique de papercraft.

#### 📝 Prompt

```
Une vidéo courte pour les réseaux sociaux de moins de 15 secondes.
* Ne pas afficher l'image jointe au début.

Thème : "#HeartAction".

Une vidéo narrative défilant horizontalement où un protagoniste se déplace de gauche à droite à travers l'écran.

L'univers visuel est un monde en papier chaleureux et simple, combinant origami, découpe de papier, papercraft et miniatures.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2099322090012938240/img/mjK1l7oc931_cZLB.jpg" width="600" alt="Prompt vidéo courte pour une association caritative">

**[🎬 Voir la vidéo →](https://x.com/taya_mama_AI/status/2099322117233971705)**

**Auteur:** [た〜や｜スキマ時間×AI副業ママ](https://x.com/taya_mama_AI) | **Source:** [Link](https://x.com/taya_mama_AI/status/2099322117233971705) | **Publié:** Sep 14, 2026

---
### Animation à l'encre de Chine dans Gemini Omni

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt narratif décrivant une animation d'histoire d'amour à l'encre de Chine créée avec Gemini Omni Flash 1.1, mettant en scène des personnages spécifiques et un timing comique.

#### 📝 Prompt

```
EMPORTÉS PAR LA VAGUE. Une histoire d'amour à l'encre de Chine dessinée directement sur du papier ligné : un homme moustachu rame, une femme tient son ombrelle, une vague dessinée à la main gâche le moment, ils en rient, des cœurs à la fin. Créé par IA dans Gemini Omni Flash 1.1, animation complète façon croquis, effets sonores inclus, timing comique intégré.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2099146429348638720/img/MOgKeTovjnfx4Szr.jpg" width="600" alt="Animation à l'encre de Chine dans Gemini Omni">

**[🎬 Voir la vidéo →](https://x.com/aibabbler/status/2099146464945393794)**

**Auteur:** [Jo Aiba](https://x.com/aibabbler) | **Source:** [Link](https://x.com/aibabbler/status/2099146464945393794) | **Publié:** Sep 13, 2026

---
### Visualisation architecturale de villa à Santorin

![English](https://img.shields.io/badge/lang-English-blue)

> Prompt décrivant une visualisation architecturale photoréaliste d'une villa surplombant les falaises de Santorin, générée par Gemini Omni 1.1 Flash.

#### 📝 Prompt

```
Luxe discret sur les falaises de Santorin. Une villa immaculée perchée au bord des falaises, conçue pour encadrer le bleu infini de la mer Égée.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2099145222941020160/img/s9ji-smMVqGNhyC3.jpg" width="600" alt="Visualisation architecturale de villa à Santorin">

**[🎬 Voir la vidéo →](https://x.com/MrDasOnX/status/2099145282219020733)**

**Auteur:** [Mr Das](https://x.com/MrDasOnX) | **Source:** [Link](https://x.com/MrDasOnX/status/2099145282219020733) | **Publié:** Sep 13, 2026

---
### Prompt Vidéo Culinaire Cinématographique : Eau Détox à la Rose

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt détaillé pour générer une vidéo culinaire cinématographique ultra-réaliste de 10 secondes au format vertical, mettant en scène la préparation d'une eau détox à la rose avec des plans macro et un design sonore soigné.

#### 📝 Prompt

```
Créez une vidéo culinaire cinématographique ultra-réaliste de 10 secondes au format vertical 9:16, basée sur le storyboard de référence. Montrez des pétales de rose frais, de la betterave, de la grenade, des carottes et des framboises préparés dans de superbes gros plans macro, avec des mains réalistes et des mouvements de découpe satisfaisants. Ajoutez rapidement les ingrédients colorés et les délicats pétales de rose dans une bouteille en verre transparent, en disposant naturellement la betterave, la grenade, les carottes et les framboises par couches. Versez lentement de l'eau pétillante fraîche dans la bouteille, en capturant de belles bulles, des éclaboussures et les ingrédients tourbillonnant dans l'eau. Terminez par un plan macro héroïque premium de l'Eau Détox à la Rose terminée, remplie d'ingrédients rouge rose vibrants, de pétales flottants, de condensation et de bulles scintillantes. Utilisez des tons riches rouge rose, cramoisi et rose doux, une lumière naturelle du jour, une faible profondeur de champ, des textures alimentaires réalistes, des mouvements de caméra cinématographiques fluides, un ralenti doux, des transitions élégantes et une esthétique luxueuse et fraîche. Incluez des sons satisfaisants de découpe, de chute d'ingrédients, de tintement de glaçons et de versement d'eau. Ajoutez des superpositions textuelles élégantes : « Eau Détox à la Rose » et « Rayonnez Naturellement · Sensation Extraordinaire ».
```

<img src="https://cms-assets.youmind.com/media/1789381245900_jwys99_HSGUc0yagAAOctA.jpg" width="600" alt="Prompt Vidéo Culinaire Cinématographique : Eau Détox à la Rose">

**[🎬 Voir la vidéo →](https://x.com/oneonelabs/status/2099143059699380331)**

**Auteur:** [OneOneLabs.ai](https://x.com/oneonelabs) | **Source:** [Link](https://x.com/oneonelabs/status/2099143059699380331) | **Publié:** Sep 13, 2026
...
**[🎬 Voir la vidéo →](https://x.com/WanderingC76/status/2097964022293549127)**

**Auteur:** [Wandering Corner](https://x.com/WanderingC76) | **Source:** [Link](https://x.com/WanderingC76/status/2097964022293549127) | **Publié:** Sep 10, 2026
...
> Un prompt de storyboard détaillé pour une publicité de boisson cinématographique à haute vitesse, mettant en avant la carbonatation, les éclaboussures macro et l'image de marque de luxe.
...
EN-TÊTE :
• Typographie contemporaine et audacieuse
• Fiches d'information :
  - Durée : 20 secondes
  - Style : Publicité cinématographique pour boisson à haute vitesse
...
• Accents graphiques minimalistes inspirés des agrumes

STORYBOARD :
1. Bouteille glacée isolée avec une forte condensation
2. Macro extrême de gouttelettes d'eau glissant le long de la bouteille
3. Ouverture du bouchon avec une explosion spectaculaire de bulles
4. Boisson pétillante jaillissant vers le haut dans une éclaboussure contrôlée
5. Tranches de citron tourbillonnant dans le liquide pétillant
6. Glaçons tombant dans un verre en cristal en ultra ralenti
7. Macro extrême montrant des milliers de bulles de carbonatation montant à travers la boisson
8. Packshot final avec la bouteille, le verre, les tranches de citron et l'éclaboussure glacée entourant le produit
...
CAMÉRA :
Photographie liquide haute vitesse 120 fps, macro extrême, éclaboussure figée, tranches de citron en rotation, contre-jour dramatique, gros plan sur la condensation, mouvement de produit fluide à 360°.
...
> Un prompt technique au format JSON pour un plan-séquence créant une cuisine vide qui s'assemble dynamiquement pièce par pièce, établissant un environnement gastronomique chaleureux et ensoleillé.

#### 📝 Prompt

```
Un plan-séquence cinématographique ininterrompu de 10 secondes, caméra fixe grand angle, sans coupes, sans mouvement de caméra. Cuisine moderne vide hyperréaliste avec des armoires blanches épurées, des comptoirs en béton poli, une grande fenêtre donnant sur les gratte-ciel de la ville et un haut plafond. Une lumière dorée et chaleureuse de fin d'après-midi traverse la fenêtre, projetant des ombres douces et mouvantes sur le sol. Aucun texte visible, à l'exception de la marque authentique sur la machine à café. De 0 à 1,5 s, une caisse élégante noir mat se trouve au centre de la cuisine vide, tremble légèrement, puis s'ouvre en douceur. De 1,5 à 3,5 s, une machine à expresso encastrable haut de gamme Slides à sa place sur le comptoir arrière et commence à préparer le café ; des tasses assorties et un petit mousseur à lait apparaissent à côté. De 3,5 à 5,5 s, des étagères ouvertes en noyer chaleureux s'élèvent le long du mur gauche et se garnissent de bols en céramique, de livres de cuisine et de bocaux en verre ; un grand îlot en marbre se déploie au centre. De 5,5 à 7,5 s, des suspensions descendent du plafond et s'illuminent chaleureusement ; des herbes en pot luxuriantes et une planche à découper en bois apparaissent sur l'îlot ; une cuisinière et un four professionnels se matérialisent sur la droite. De 7,5 à 9 s, un évier de ferme avec un robinet en laiton s'installe sous la fenêtre, des torchons en lin sont suspendus et un petit écran intelligent apparaît en fondu sur la crédence. La dernière seconde se fige sur la cuisine gastronomique chaleureuse et ensoleillée terminée, avec de la vapeur s'élevant d'un expresso fraîchement préparé. Physique photoréaliste, assemblage précis, chaleur moderne et élégante. Audio : sons ambiants doux de cuisine et préparation de la machine à expresso à partir de 1,5 s, mélodie apaisante jusqu'à la fin.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096972853468102656/img/CckSt3zqQLFxhq6O.jpg" width="600" alt="Plan-séquence de l'assemblage d'une cuisine gastronomique">

**[🎬 Voir la vidéo →](https://x.com/MrDasOnX/status/2096972925140365437)**

**Auteur:** [Mr Das](https://x.com/MrDasOnX) | **Source:** [Link](https://x.com/MrDasOnX/status/2096972925140365437) | **Publié:** Sep 7, 2026

---
### Storyboard publicitaire premium pour Nutella

![English](https://img.shields.io/badge/lang-English-blue)

> Un storyboard publicitaire de luxe pour pâte à tartiner aux noisettes, mettant l'accent sur la texture, le geste de tartinage et un éclairage chaleureux.

#### 📝 Prompt

```
TITRE :
Storyboard publicitaire premium pour produit Nutella
...
- Produit : Pâte à tartiner aux noisettes Nutella
- Audio : Bruit de tartinage doux + ASMR culinaire
  • Section « Pourquoi ce style fonctionne »
...
2. Ouverture du couvercle en macro extrême
...
7. Pile de pancakes entourée du pot mis en avant et de noisettes
8. Packshot final du produit de luxe avec un tartinage spectaculaire de Nutella
...
CAMÉRA :
Macro extrême, photographie de tartinage au ralenti, vue plongeante culinaire, travelling avant contrôlé, faible profondeur de champ, cadrage cinématographique du produit phare.

STYLE :
Publicité culinaire ultra-réaliste, viscosité réaliste de la pâte, texture chocolatée brillante, éclairage studio chaleureux, emballage en verre premium, présentation gastronomique sophistiquée, 8K.
```

<img src="https://cms-assets.youmind.com/media/1788857248820_drevcx_HRm94c_aAAET3K6.jpg" width="600" alt="Storyboard publicitaire premium pour Nutella">

**[🎬 Voir la vidéo →](https://x.com/itxabdullaa/status/2096915887504982258)**

**Auteur:** [ÀBDŪLLÂH](https://x.com/itxabdullaa) | **Source:** [Link](https://x.com/itxabdullaa/status/2096915887504982258) | **Publié:** Sep 7, 2026

---
### Time-lapse de la floraison des quatre saisons

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt narratif cinématographique pour Gemini Omni qui visualise le passage d'une année en dix secondes, montrant une fleur à travers le soleil, la pluie, l'automne et le gel hivernal.

#### 📝 Prompt

```
Une fleur éclot sous un soleil chaleureux, la pluie arrive, l'automne prend le relais, puis l'hiver recouvre tout de givre et de neige.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096834081900351488/img/JJSWuWqW1DRFcBQj.jpg" width="600" alt="Time-lapse de la floraison des quatre saisons">

**[🎬 Voir la vidéo →](https://x.com/AI_VideoLab/status/2096834109402497110)**

**Auteur:** [AI Video Lab｜AI Filmmaking](https://x.com/AI_VideoLab) | **Source:** [Link](https://x.com/AI_VideoLab/status/2096834109402497110) | **Publié:** Sep 7, 2026

---
### Storyboard publicitaire pour sirop d'érable premium

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de storyboard cinématographique professionnel pour une publicité de sirop d'érable de luxe, incluant des plans macro détaillés de sirop qui coule et une présentation de pancakes gastronomiques.

#### 📝 Prompt

```
TITRE :
Storyboard pour publicité de sirop d'érable premium
...
• Fiches d'informations :
  - Durée : 20 secondes
  - Style : Publicité culinaire gastronomique cinématographique
  - Produit : Sirop d'érable pur
  - Audio : Son de versage lent + ASMR culinaire doux
• Section « Pourquoi ce style fonctionne »
• Esthétique aux tons ambre chaud, crème et brun foncé
...
4. Le sirop formant un ruban brillant dans les airs
5. Le sirop se déversant en cascade sur des pancakes moelleux
...
8. Packshot final du produit de luxe avec un versement de sirop spectaculaire
...
CAMÉRA :
Macro extrême, photographie de liquide au ralenti, prise de vue culinaire en plongée, travelling avant contrôlé, faible profondeur de champ, cadrage cinématographique du produit phare.

STYLE :
Publicité culinaire ultra-réaliste, viscosité du sirop réaliste, texture dorée brillante, éclairage de studio chaleureux, emballage en verre premium, présentation gastronomique sophistiquée, 8K.
```

<img src="https://cms-assets.youmind.com/media/1788857251032_k6cgg4_HRlyjBWaIAER5_L.jpg" width="600" alt="Storyboard publicitaire pour sirop d'érable premium">

**[🎬 Voir la vidéo →](https://x.com/Strength04_X/status/2096833097740493050)**

**Auteur:** [𝐌](https://x.com/Strength04_X) | **Source:** [Link](https://x.com/Strength04_X/status/2096833097740493050) | **Publié:** Sep 7, 2026

---
### Publicité cinématographique avec texte 3D interactif

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt détaillé de génération vidéo pour créer une publicité rythmée où un personnage interagit avec des éléments textuels dynamiques dans un travelling horizontal continu.
...
Maintenez la couleur d'arrière-plan initiale tout au long de la séquence.

La caméra suit le personnage avec un travelling horizontal continu, se déplaçant à ses côtés pendant qu'il marche.

Le texte et les lignes de connexion apparaissent progressivement à l'écran, formant un parcours visuel continu.

À mesure que le personnage avance, il perçoit le texte et les éléments graphiques qui apparaissent autour de lui comme des objets physiques existant réellement dans le même espace. Il interagit naturellement avec ces éléments en avançant : il touche occasionnellement le texte à proximité du bout des doigts, lève les yeux vers les mots situés au-dessus de lui, jette un coup d'œil latéral aux graphismes, s'écarte légèrement pour éviter un élément, se baisse pour passer en dessous ou s'arrête brièvement pour observer quelque chose.

Une ligne continue, ressemblant à une voie ferrée ou à un itinéraire visuel, relie les éléments textuels entre eux. Le texte de l'image de référence apparaît séquentiellement le long de ce chemin connecté, en respectant l'ordre original.

Le texte et les éléments graphiques ne doivent pas donner l'impression d'être des décorations d'arrière-plan plates. Ils doivent sembler physiquement présents dans le même espace tridimensionnel que le personnage, avec des relations spatiales et une interaction convaincantes.

Ne répétez ni ne dupliquez aucun texte.

Gardez un rythme global rapide, cadencé et fluide. Le mouvement de travelling horizontal doit rester continu et ininterrompu tout au long de la séquence.

Reproduisez fidèlement tout le texte de l'image de référence sans caractères tronqués, typographie corrompue, fautes d'orthographe ou modification du libellé.

Pour la transition finale, un grand objet au premier plan ou un élément graphique passe très près devant la caméra, couvrant complètement tout le cadre et créant une transition naturelle par flou de premier plan.

Lorsque l'objet de premier plan quitte le cadre, révélez en fondu l'écran du logo final.

Le mouvement de caméra doit être fluide, dynamique et cinématographique.

Donnez la priorité absolue à l'interaction entre le personnage et les éléments textuels/graphiques.

Musique de fond : Musique rythmée et entraînante avec un tempo marqué.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096611422797283328/img/C8LAesMcDr9ILny6.jpg" width="600" alt="Publicité cinématographique avec texte 3D interactif">

**[🎬 Voir la vidéo →](https://x.com/taya_mama_AI/status/2096612096003965254)**

**Auteur:** [た〜や｜スキマ時間×AI副業ママ](https://x.com/taya_mama_AI) | **Source:** [Link](https://x.com/taya_mama_AI/status/2096612096003965254) | **Publié:** Sep 6, 2026

---
### Prompt vidéo réaliste d'interaction avec un poisson à tête de chat

![中文](https://img.shields.io/badge/lang-中文-red)

> Un prompt vidéo très complexe pour Gemini Omni permettant de créer une interaction réaliste entre une main humaine et un poisson surréaliste à tête de chat, incluant des effets de caresse basés sur la physique et des effets d'expansion.

#### 📝 Prompt

```
Générez une vidéo photoréaliste verticale 9:16 de 10 secondes. L'intégralité du film est un plan séquence continu sans coupures ni transitions cachées. Trois minuscules « poissons à tête de chat » se trouvent dans une eau claire et peu profonde. Le sujet principal est un visage de chaton Napoleon/Minuet noir et blanc fusionné naturellement avec un petit corps de poisson en forme de goutte d'eau, doté de vraies oreilles triangulaires, d'yeux humides brillants et de fines moustaches. Une main humaine soulève le poisson hors de l'eau, révélant des textures de peau nettes et des gouttelettes d'eau. Le poisson est caressé, puis se gonfle comme un poisson-globe pour devenir une sphère poilue tout en conservant ses traits de chaton et son motif noir et blanc. Il est doucement pressé, montrant une déformation physique réaliste, et finit par projeter de l'eau sur l'objectif de la caméra, provoquant des gouttes d'eau réalistes et un flou temporaire. Les sons ambiants incluent l'écoulement de l'eau, un minuscule miaulement lorsqu'il est caressé et le bruit de l'eau frappant l'objectif. Pas de musique de fond, pas d'éléments d'interface utilisateur et pas de transitions saccadées.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096476920863186944/img/GShVIT8GBnBuTH9Q.jpg" width="600" alt="Prompt vidéo réaliste d'interaction avec un poisson à tête de chat">

**[🎬 Voir la vidéo →](https://x.com/acupofai/status/2096481317936648685)**

**Auteur:** [Lc造片实验室](https://x.com/acupofai) | **Source:** [Link](https://x.com/acupofai/status/2096481317936648685) | **Publié:** Sep 6, 2026

---
### Vidéo humoristique « Pensée par une nuit tranquille » style Pixar

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt vidéo multimodal qui réinvente le poème classique chinois de Li Bai « Pensée par une nuit tranquille » dans un style d'animation comique 3D façon Pixar, incluant des descriptions de plans précises et des paysages sonores.

#### 📝 Prompt

```
integrated_multimodal_description:
[Plan 1] Animation 3D CG, style Pixar, un plan moyen-large cadre un érudit de dessin animé potelé avec un minuscule chignon et une robe ample de style Tang, assis sur un lit en bois dans une chambre ancienne et chaleureuse. Un clair de lune brillant dessine un carré lumineux sur le sol. Il se frotte les yeux, pointe le carré et dit : [Chinois] 床前明月光……

[Plan 2] À 00:06.000, coupe vers un plan plus rapproché. Il s'agenouille, touche le clair de lune, essaie de le rouler en boule de neige mais ses mains se referment sur le vide. Il marmonne : [Chinois] 疑是地上霜…… puis lèche le sol, grimace et hausse les épaules.

[Plan 3] À 00:12.000, plan en contre-plongée. Son cou craque alors qu'il regarde vers la fenêtre. La caméra s'incline vers le haut pour révéler une pleine lune dorée et chaleureuse avec un visage de dessin animé endormi qui bâille. Sa mâchoire tombe, il pointe du doigt avec admiration : [Chinois] 举头望明月……

[Plan 4] À 00:18.500, vue latérale. Une bulle de pensée duveteuse montre sa ville natale : des nouilles fumantes et un chien qui remue la queue. Il murmure : [Chinois] 低头思故乡…… Soudain, son estomac gargouille bruyamment. Il attrape un baluchon, sprinte, trébuche sur le seuil et tombe sur le dos. La lune glousse silencieusement. Fin à 25,00 s.

overall_soundscape: Grillons nocturnes, bruissement de bambous, craquements de cou comiques, un bruit sourd de chute et un gargouillement d'estomac sonore.
non_diegetic_music: Mélodie bondissante au pipa, ralentissant vers une phrase tendre au guzheng, puis revenant brusquement à un tourbillon comique rapide avec un coup de cymbale.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096466125425090560/img/gATyGN81v1LPxYIo.jpg" width="600" alt="Vidéo humoristique « Pensée par une nuit tranquille » style Pixar">

**[🎬 Voir la vidéo →](https://x.com/7998l201/status/2096469551882121293)**

**Auteur:** [Ryan](https://x.com/7998l201) | **Source:** [Link](https://x.com/7998l201/status/2096469551882121293) | **Publié:** Sep 6, 2026

---
### Time-lapse macro de la transformation saisonnière d'une fleur sauvage

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de time-lapse macro cinématographique pour Gemini Omni qui capture le voyage d'une fleur sauvage à travers le printemps, l'été, l'automne et l'hiver, se terminant par une superposition de texte poétique.
...
```
{
  ...
  "aspect_ratio": "16:9",
  "fps": 24,
  "style": "Réalisme cinématographique, cinématographie macro en time-lapse, fidélité visuelle type National Geographic, faible profondeur de champ",
  "prompt": "Un time-lapse macro continu de 10 secondes centré sur une fleur sauvage solitaire et rayonnante poussant dans un sol moussu sombre, capturant le passage des quatre saisons pour évoquer l'impermanence. De 0:00 à 0:03, la lumière dorée du matin printanier illumine des pétales éclatants qui s'épanouissent avec des gouttes de rosée scintillantes. De 0:03 à 0:06, la lumière du soleil s'intensifie pour atteindre la chaleur du plein été avant de passer rapidement à l'ambre automnal ; les pétales sèchent, se recroquevillent et développent de riches teintes bordeaux et ocre. De 0:06 à 0:08, un givre cristallin délicat et une légère neige recouvrent la fleur qui se fane sous un crépuscule froid. De 0:08 à 0:10, une rafale hivernale disperse les pétales séchés et la poussière de neige dans l'air, révélant un sol vide et silencieux. Dans la scène finale (0:08–0:10), une typographie serif élégante et minimaliste apparaît en fondu au centre de l'image, affichant : 'Tout est temporaire…' dans un blanc cassé chaud et translucide avec un léger flou et une douce diffusion de lumière avant de passer au noir.",
  "lighting": "Éclairage dynamique passant de manière fluide d'une lumière dorée à l'aube à une lumière de plein été nette, un ciel automnal maussade et un crépuscule hivernal cristallin et froid.",
  "camera": "Objectif macro 85mm, f/2.8, orbite circulaire lente avec un léger zoom avant, maintenant la mise au point centrée sur la fleur jusqu'au fondu final du texte.",
  "text_overlay": {
    "text": "Tout est temporaire…",
    "timestamp": "0:08 - 0:10",
    "font_style": "Minimaliste, serif élégant, blanc cassé avec une lueur douce, texture de grain de film subtile, fondu en ouverture et en fermeture fluide",
    "placement": "Centre de l'écran"
  },
  "audio_cues": "Doux chant d'oiseaux ambiant se transformant en bruissement de feuilles sèches, vent d'hiver doux et sifflant, et un accord de piano ambiant profond qui s'estompe sous le texte final."
}
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096453926442950656/img/sz0h96hWwb2tWa7R.jpg" width="600" alt="Time-lapse macro de la transformation saisonnière d'une fleur sauvage">

**[🎬 Voir la vidéo →](https://x.com/MrDasOnX/status/2096453993371422748)**

**Auteur:** [Mr Das](https://x.com/MrDasOnX) | **Source:** [Link](https://x.com/MrDasOnX/status/2096453993371422748) | **Publié:** Sep 6, 2026

---
### Storyboard pour publicité de yaourt grec

![English](https://img.shields.io/badge/lang-English-blue)

> Un storyboard complet multi-scènes pour une publicité de yaourt grec premium, axé sur la photographie culinaire macro et les éléments ASMR.
...
• Storyboard premium sur une page
• Format portrait 3:4
• Campagne de produits laitiers haut de gamme
• 8 scènes cinématographiques centrées sur le produit
• Le produit reste l'élément visuel principal
• Présentation d'agence publicitaire de luxe
...
• Fiches d'information :
  ...
  - Produit : Yaourt grec aux fruits
  - Audio : ASMR cuillère + texture crémeuse
• Section « Pourquoi ce style fonctionne »
• Esthétique blanc, rose tendre et rouge baie
...
2. Opercule du yaourt se décollant en plan macro extrême
3. Cuillère plongeant dans le yaourt épais et crémeux
...
CAMÉRA :
Macro extrême, chute de fruits au ralenti, gros plan sur la texture crémeuse, composition en plongée, mouvement fluide de la cuillère, faible profondeur de champ, cadrage cinématographique.

STYLE :
Photographie culinaire laitière ultra-réaliste, texture crémeuse épaisse, morceaux de fruits réalistes, tourbillon de baies brillant, condensation fraîche, éclairage premium doux, emballage épuré, publicité alimentaire de luxe, 8K.
```

<img src="https://cms-assets.youmind.com/media/1788684290650_ymi1pv_HRc2tm_aQAEZ3wO.jpg" width="600" alt="Storyboard pour publicité de yaourt grec">

**[🎬 Voir la vidéo →](https://x.com/Strength04_X/status/2096204332895261103)**

**Auteur:** [𝐌](https://x.com/Strength04_X) | **Source:** [Link](https://x.com/Strength04_X/status/2096204332895261103) | **Publié:** Sep 5, 2026

---
### Vidéo d'échange de visage par IA réaliste

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de flux de travail pour effectuer des échanges de visages fluides dans des vidéos, en conservant le mouvement et l'arrière-plan d'origine tout en adaptant l'éclairage pour un rendu réaliste.

#### 📝 Prompt

```
Remplacez la personne dans cette vidéo par la personne présente sur l'image de référence. Conservez les mêmes mouvements, le mouvement de la tête, la parole, la caméra et l'arrière-plan. Échange de visage réaliste et fluide. Adaptez l'éclairage. Haute précision.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095908418649231360/img/Scv3L_bJM4K8xwxD.jpg" width="600" alt="Vidéo d'échange de visage par IA réaliste">

**[🎬 Voir la vidéo →](https://x.com/___craig2x/status/2096164337400312189)**

**Auteur:** [That Arsenal Guy](https://x.com/___craig2x) | **Source:** [Link](https://x.com/___craig2x/status/2096164337400312189) | **Publié:** Sep 5, 2026

---
### Macro de l'assemblage d'un autobus miniature

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt vidéo macro pour Gemini Omni montrant des mains humaines assemblant un autobus miniature, avec des portes pliantes fonctionnelles et des lumières.

#### 📝 Prompt

```
Créez une vidéo macro hyperréaliste d'un autobus miniature en cours d'assemblage sur une table d'atelier. Des mains humaines installent le châssis, les roues, les sièges, le système de direction, les fenêtres, les portes et les composants du moteur. Montrez les portes pliantes miniatures s'ouvrant et les lumières intérieures s'allumant. Terminez avec l'autobus terminé se déplaçant le long d'une route miniature. Photographie macro cinématographique, matériaux réalistes, 9:16.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096154538961211393/img/3S-nXU65MlZ7_8hN.jpg" width="600" alt="Macro de l'assemblage d'un autobus miniature">

**[🎬 Voir la vidéo →](https://x.com/abs_uiux/status/2096154692430467299)**

**Auteur:** [Abkr Sadiq](https://x.com/abs_uiux) | **Source:** [Link](https://x.com/abs_uiux/status/2096154692430467299) | **Publié:** Sep 5, 2026

---
### Scène de drainage d'inondation dans un village miniature

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt vidéo macro cinématographique décrivant une main géante plaçant une pompe à eau dans un village européen miniature inondé, créant une physique de l'eau réaliste et des réactions détaillées de minuscules ouvriers.

#### 📝 Prompt

```
Créez une scène miniature hyperréaliste et cinématographique d'une rue étroite de village européen ancien complètement inondée. Des dizaines de minuscules ouvriers du bâtiment portant des casques de sécurité jaunes et des vêtements de travail sont debout ou assis le long des deux côtés de la rue inondée, l'air inquiet, dans l'attente de secours.

Une main humaine géante entre dans le cadre par le haut, tenant une petite pompe à eau puissante orange et noire. La main place délicatement la pompe dans la rue inondée. La pompe se met en marche et draine rapidement l'eau, créant des ondulations réalistes, des courants tourbillonnants et des éclaboussures. À mesure que le niveau de l'eau baisse, la route pavée mouillée devient progressivement visible.

Les minuscules ouvriers réagissent avec enthousiasme et soulagement alors que la rue se transforme, passant d'une voie inondée à une rue pavée sèche. Maintenez un contraste d'échelle marqué entre la main géante, la machine et les personnages miniatures.

Composition verticale 9:16, photographie macro, faible profondeur de champ, physique de l'eau réaliste, personnages miniatures détaillés, éclairage cinématographique, textures réalistes, mouvement de caméra fluide, hautement détaillé, photoréaliste, transformation satisfaisante, 4K, sans texte, sans sous-titres.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096141092152619008/img/-0EP6u5EztZ-R0zC.jpg" width="600" alt="Scène de drainage d'inondation dans un village miniature">

**[🎬 Voir la vidéo →](https://x.com/AiwithBloodline/status/2096141138986185150)**

**Auteur:** [Dr Bloodline | AI](https://x.com/AiwithBloodline) | **Source:** [Link](https://x.com/AiwithBloodline/status/2096141138986185150) | **Publié:** Sep 5, 2026

---
### Prompt vidéo culinaire pour le tofu braisé Hakka

![中文](https://img.shields.io/badge/lang-中文-red)

> Un prompt commercial professionnel complet pour une publicité culinaire haut de gamme de 40 secondes présentant le processus traditionnel de préparation du tofu braisé Hakka.

#### 📝 Prompt

```
Exigences unifiées pour l'ensemble du film : Quatre segments générés séparément, 10 secondes chacun, format vertical 9:16, qualité publicitaire cuisine Hakka haut de gamme ultra-réaliste 4K, rendu cinématographique 24 images/seconde. Utilisez systématiquement un environnement de cuisine Hakka traditionnelle chaleureux et naturel, un plan de travail en bois sombre, un rétroéclairage latéral chaud et une photographie macro à faible profondeur de champ. Le tofu doit rester uniforme dans les quatre segments : tofu Hakka traditionnel, blanc laiteux aux tons chauds, texture fine avec de légers pores naturels, coupé en blocs rectangulaires épais et réguliers ; ne doit pas se transformer en tofu soyeux, tofu japonais, tofu aux œufs, fromage ou pain. La farce à la viande utilise toujours le même porc frais, avec un rapport gras/maigre naturel, préservant des grains de viande nets et une couleur réaliste. La taille, la forme, la quantité de farce et la couleur de saisie de tout le tofu farci doivent être continues et unifiées. Les visuels ne montrent que les ingrédients, les mains du chef et les ustensiles de cuisine, aucun visage. Interdiction des sous-titres, textes, logos de marque, filigranes, sacs d'emballage et interfaces de plateforme. Segment 1 (0—10s) : Sélection des graines de soja et lait de soja moulu à la pierre traditionnelle. Prompt : Générez une vidéo publicitaire de cuisine Hakka haut de gamme, 10 secondes, vertical 9:16, 4K ultra-réaliste. Montrez la première étape de la fabrication du tofu farci Hakka : sélection des graines de soja et utilisation d'une meule en granit traditionnelle pour moudre le lait de soja fin. 0—2s : Lumière matinale chaude dans une cuisine Hakka traditionnelle. Un tamis en bambou de couleur claire est rempli de graines de soja jaune doré pâle, dodues et uniformes. La caméra s'approche des grains, montrant la texture et l'éclat frais. 2—4s : Une main propre et naturelle remue et sélectionne délicatement les graines de soja. Les graines ne doivent pas devenir noires, moisies, craquelées, ni se transformer en maïs, arachides ou grains de café. 4—6s : Transition vers la meule en granit circulaire traditionnelle. Graines de soja trempées et eau ajoutées dans l'ouverture, le chef pousse la meule. 6—8s : Le lait de soja blanc laiteux s'écoule de l'interstice. La texture est fine et lisse. 8—10s : Macro 85mm suivant le lait dans un seau. Rétroéclairage latéral chaud, vapeur naturelle. Connexion : La dernière image montre un gros plan sur le lait de soja. Le segment 2 utilise le même lot de tofu. Segment 2 (10—20s) : Hachage manuel de la farce et garnissage. Prompt : Générez une vidéo publicitaire de cuisine Hakka haut de gamme, 10 secondes, vertical 9:16, 4K ultra-réaliste. Montrez le hachage manuel du porc frais, la découpe du tofu et le garnissage de la farce. 0—2s : Épaule de porc fraîche sur une planche en bois sombre. 2—4s : Hachage manuel rythmé, préservant des grains nets. 4—5s : Rassemblement de la viande avec un couteau, morceaux d'oignons verts visibles. 5—7s : Tofu coupé en blocs de 4x3x2,5cm. Creusement d'une rainure au centre. 7—9s : Remplissage de la viande avec des baguettes. 9-10s : Balayage sur le tofu farci soigneusement disposé. Utilisez des macros 50mm et 85mm. Strictement évité : Hachoirs à viande, viande se transformant en d'autres produits, creusement automatique, formes différentes, tofu gélatineux. Connexion : La dernière image montre le tofu disposé. Segment 3 (20—30s) : Saisie et braisage. Prompt : Générez une vidéo publicitaire de cuisine Hakka haut de gamme, 10 secondes, vertical 9:16, 4K ultra-réaliste. Montrez la saisie du côté viande, des deux côtés du tofu, et le braisage dans son jus original en utilisant une marmite en fer noir. 0—2s : Chauffer la marmite avec de l'huile, placer le tofu côté viande vers le bas. 2—4s : Côté viande saisi jusqu'à obtenir une couleur dorée. 4—6s : Saisie des deux côtés. 6—8s : Verser la sauce ambrée. 8—9s : Mijotage dans le jus. 9—10s : Spatule soulevant un morceau. Strictement évité : Friture, brûlure, viande qui tombe, mauvaises couleurs de sauce. Connexion : Transfert vers une marmite en terre cuite brun-noir. Segment 4 (30—40s) : Mijotage en marmite et plan héroïque. Prompt : Générez une vidéo publicitaire de cuisine Hakka haut de gamme, 10 secondes, vertical 9:16, 4K ultra-réaliste. Montrez le transfert dans la marmite en terre cuite, le mijotage, l'ajout d'oignons verts et un plan héroïque avec une cuillère. 0—2s : Tofu mijotant dans le jus ambré, vapeur s'élevant. 2—4s : Ajustement du tofu avec des baguettes. 4—5s : Saupoudrage d'oignons verts. 5—7s : Cuillère en argent soulevant un morceau. 7—9s : Plan héroïque macro 85mm montrant les textures et le jus. 9—10s : La caméra recule pour le plan final. Strictement évité : Changement de marmite, changements de forme, différents aliments, viande qui tombe, trop de sauce, tofu au charbon, doigts supplémentaires, éléments d'interface utilisateur.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096067905817628672/img/tKXsWCbLMzQrwJkm.jpg" width="600" alt="Prompt vidéo culinaire pour le tofu braisé Hakka">

**[🎬 Voir la vidéo →](https://x.com/7998l201/status/2096067992702566499)**

**Auteur:** [Ryan](https://x.com/7998l201) | **Source:** [Link](https://x.com/7998l201/status/2096067992702566499) | **Publié:** Sep 5, 2026

---
### Prompt pour vidéo timelapse de dessin numérique

![中文](https://img.shields.io/badge/lang-中文-red)

> Un prompt détaillé pour créer un timelapse de dessin numérique haute vitesse de 15 secondes, montrant le processus depuis une toile vierge jusqu'à un personnage entièrement rendu avec des interactions d'interface utilisateur visibles.

#### 📝 Prompt

```
Dans une interface professionnelle de dessin numérique et de conception de personnages, créez un timelapse accéléré de 15 secondes illustrant la création d'un personnage. Utilisez la référence de personnage fournie uniquement comme objectif final pour l'apparence, les proportions et la coiffure. Le processus doit commencer sur une toile vierge et reconstruire le personnage à partir de zéro. Affichez un curseur de souris visible contrôlant activement le processus. 0:00-0:02 Début sur une toile vierge ; le curseur crée une structure libre et une pose de base. 0:02-0:05 Étape de croquis détaillé accéléré. 0:05-0:08 Transition vers un line art propre. 0:08-0:11 Étape de colorisation rapide avec ombres et reflets. 0:11-0:13 Rendu et finitions avec zooms. 0:13-0:15 L'interface s'efface pour révéler le personnage entièrement rendu correspondant à la référence. Style : Timelapse d'art numérique haute vitesse, interface de flux de travail professionnel, mouvements de curseur fluides. Mouvement : Continu et efficace. Caméra : Style enregistrement d'écran avec zooms subtils. Important : Le personnage ne doit pas apparaître instantanément ; chaque étape doit se construire visiblement sur la précédente.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095770843024670720/img/zuMlz3_pPRGYAL7U.jpg" width="600" alt="Prompt pour vidéo timelapse de dessin numérique">

**[🎬 Voir la vidéo →](https://x.com/mushengziyue/status/2095770916068164050)**

**Auteur:** [ailth](https://x.com/mushengziyue) | **Source:** [Link](https://x.com/mushengziyue/status/2095770916068164050) | **Publié:** Sep 4, 2026

---
### Storyboard publicitaire pour spaghettis italiens premium

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de storyboard complet pour une publicité de produits alimentaires italiens, détaillant des plans cinématographiques incluant la cuisson des pâtes, l'enroulement à la fourchette et des détails de texture en macro.
...
• Storyboard premium sur une page
• Format portrait 3:4
• Campagne pour produits alimentaires haut de gamme
• 8 scènes cinématographiques centrées sur le produit
• Le produit reste l'élément visuel central
...
• Cartes d'information :
  - Durée : 20 secondes
  - Style : Publicité authentique pour cuisine italienne
  - Produit : Spaghettis premium
  - Audio : Cuisson des pâtes + ASMR de cuisine italienne
• Section « Pourquoi ce style fonctionne »
• Esthétique crème, or blé et vert profond
• Éléments décoratifs minimalistes d'inspiration italienne

STORYBOARD :
1. Paquet de spaghettis premium posé verticalement à côté de brins de pâtes crues
2. Ouverture du paquet avec extraction de longs brins de spaghettis
3. Spaghettis tombant dans une casserole d'eau bouillante
4. Pâtes tourbillonnant sous l'eau avec des bulles et un mouvement réaliste
5. Spaghettis cuits soulevés de la casserole avec de la vapeur s'en dégageant
...
8. Plan final du produit avec le paquet de pâtes à côté d'une assiette de spaghettis joliment dressée
...
CAMÉRA :
Composition en plongée, macro sous-marine, gros plan sur la vapeur, levée de pâtes au ralenti, plan de rotation de fourchette, détail de texture extrême, packshot cinématographique.

STYLE :
Publicité culinaire italienne ultra-réaliste, texture de pâtes authentique, vapeur et eau réalistes, emballage détaillé, éclairage cinématographique chaleureux, présentation gastronomique premium, ingrédients naturels, 8K.
```

<img src="https://cms-assets.youmind.com/media/1788426358015_1tgujv_HRRlezKbQAAQ8BS.jpg" width="600" alt="Storyboard publicitaire pour spaghettis italiens premium">

**[🎬 Voir la vidéo →](https://x.com/Strength04_X/status/2095411329461100949)**

**Auteur:** [𝐌](https://x.com/Strength04_X) | **Source:** [Link](https://x.com/Strength04_X/status/2095411329461100949) | **Publié:** Sep 3, 2026

---
### Prompt JSON cinématique pour parfum de luxe

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt technique structuré en JSON pour créer une publicité de parfum de luxe avec des détails macro sur le verre, de la soie tourbillonnante et de la poussière d'or en un plan continu.
...
```
{
  ...
  "aspect_ratio": "16:9",
  "shot": {
    "structure": "plan unique continu sans coupure",
    "composition": "débute en macro extrême sur un grand flacon de parfum en cristal facetté, suit la soie et la poussière d'or tourbillonnant autour, termine sur un plan héroïque centré",
    "lens": "100mm macro pour les détails du verre, puis 50mm pour la révélation du produit",
    "frame_rate": "24fps cinématique",
    "camera_movement": "travelling avant lent sur le flacon, dérive orbitale douce alors que les pétales et la soie s'élèvent, plan fixe sur l'image finale"
  },
  "timeline": {
    "0-2s": "Studio de luxe tamisé sur marbre noir. Grand flacon de parfum en cristal facetté contenant un liquide ambré doré. Lumière de bougie chaude glissant sur les arêtes vives du verre, reflets ultra-réalistes et caustiques.",
    "2-4s": "De la soie champagne diaphane et une fine poussière d'or tourbillonnent autour du flacon au ralenti. Une brume chaude et douce s'élève. Les particules captent les faisceaux lumineux.",
    "4-6s": "Le liquide à l'intérieur du flacon tourbillonne doucement comme s'il était vivant. Des particules dorées s'élèvent. Le bouchon doré se soulève légèrement avec une subtile lueur de réalisme magique.",
    "6-8s": "Le spray du parfum éclate au ralenti et se transforme en rubans de soie fluides, en pétales de jasmin de nuit et de tubéreuse qui se dissolvent en vapeur dorée.",
    "8-10s": "Plan héroïque final. Flacon centré sur le marbre noir, entouré d'une brume lumineuse, de plis de soie et de pétales épars. Projecteur chaud et lumière de bougie. Focus sur la marque de luxe."
  },
  "subject": {
    "description": "un grand flacon de parfum en cristal facetté avec un liquide ambré doré, du tissu de soie, de la poussière d'or et des fleurs nocturnes s'assemblant autour",
    "props": "flacon en cristal, bouchon doré, soie champagne, pétales de jasmin et de tubéreuse, brume chaude"
  },
  "scene": {
    "location": "studio sombre et élégant avec marbre noir brillant",
    "time_of_day": "nuit intemporelle, lumière de bougie chaude",
    "environment": "décor de luxe discret, surface réfléchissante, brume légère, sans présence humaine"
  },
  "visual_details": {
    "action": "la lumière glisse sur le verre, la soie et les pétales tourbillonnent, le bouchon se soulève, le spray devient vapeur et formes florales, le flacon se stabilise dans une pose héroïque en lévitation",
    "special_effects": "poussière d'or au ralenti, caustiques liquides, métamorphose de soie en suspension, scintillement subtil de lévitation"
  },
  "cinematography": {
    "lighting": "lumière principale de bougie chaude, faisceaux de projecteurs dramatiques, reflets sur marbre brillant, lumière de contour dorée douce",
    "color_palette": "noir profond, or champagne, ambre, pétales ivoire",
    "tone": "intime, luxe patrimonial, sensualité discrète"
  },
  "audio": {
    "music": "drone ambiant chaud et subtil avec un léger carillon de cristal",
    "ambient": "bruissement doux de soie, scintillement de bougie, calme du studio",
    "sound_effects": "éclat délicat du spray, pétales qui se déposent, résonance calme du verre",
    "mix": "intime, raffiné, centré sur le produit, sans voix"
  },
  "constraints": {
    "dialogue": "aucun",
    "voiceover": "aucun"
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2095135814024089600/img/fC7nzZ1tr6CBZkao.jpg" width="600" alt="Prompt JSON cinématique pour parfum de luxe">

**[🎬 Voir la vidéo →](https://x.com/MrDasOnX/status/2095135918432632856)**

**Auteur:** [Mr Das](https://x.com/MrDasOnX) | **Source:** [Link](https://x.com/MrDasOnX/status/2095135918432632856) | **Publié:** Sep 2, 2026

---
### Storyboard pour publicité de beurre de cacahuète gourmet

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de storyboard pour une publicité de beurre de cacahuète haut de gamme, détaillant des plans macro de textures onctueuses, le raclage à la cuillère et des chutes d'ingrédients au ralenti.

#### 📝 Prompt

```
TITRE :
Storyboard pour publicité de produit de beurre de cacahuète premium

FORMAT :
• Storyboard premium sur une page
• Format portrait 3:4
• Campagne pour produit de petit-déjeuner gourmet
• 8 scènes cinématographiques centrées sur le produit
• Le produit reste l'élément central
• Présentation publicitaire de luxe
...
• Fiches d'information :
  - Durée : 20 secondes
  - Style : Publicité alimentaire gourmet
  - Produit : Beurre de cacahuète onctueux
  - Audio : Raclage de cuillère + ASMR doux
• Section « Pourquoi ce style fonctionne »
• Esthétique beige chaud, caramel et marron
• Éléments décoratifs minimalistes inspirés de la cacahuète

STORYBOARD :
1. Pot de beurre de cacahuète posé sur une surface en pierre premium avec des cacahuètes entières autour
2. Couvercle du pot retiré, révélant un beurre de cacahuète parfaitement lisse
3. Cuillère entrant dans le pot en plan macro extrême
4. Épais beurre de cacahuète s'étirant lentement de la cuillère en un long ruban onctueux
5. Beurre de cacahuète s'étalant en douceur sur du pain chaud grillé
6. Cacahuètes grillées tombant autour du pot au ralenti
7. Macro extrême montrant la texture onctueuse avec de minuscules particules de cacahuète
8. Pot final mis en valeur à côté de la tartine et de cacahuètes grillées éparpillées
...
CAMÉRA :
Macro extrême, étalement au ralenti, composition en vue plongeante, gros plan sur la texture onctueuse, chute d'ingrédients contrôlée, travelling avant fluide sur le produit.

STYLE :
Photographie culinaire ultra-réaliste, texture riche et onctueuse, viscosité réaliste, détails de cacahuètes grillées, éclairage naturel chaud, emballage en verre premium, publicité sophistiquée pour le petit-déjeuner, 8K.
```

<img src="https://cms-assets.youmind.com/media/1788426360165_e2mvlq_HRNN_7uakAAOsdV.jpg" width="600" alt="Storyboard pour publicité de beurre de cacahuète gourmet">

**[🎬 Voir la vidéo →](https://x.com/Strength04_X/status/2095104027667177825)**

**Auteur:** [𝐌](https://x.com/Strength04_X) | **Source:** [Link](https://x.com/Strength04_X/status/2095104027667177825) | **Publié:** Sep 2, 2026

---
### Atelier miniature de cerises inspiré par Ghibli

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt cinématographique et fantaisiste pour une animation de style Ghibli mettant en scène de minuscules personnages récoltant et transformant une cerise rouge géante en confiture.

#### 📝 Prompt

```
Créez un atelier miniature fantaisiste et cinématographique inspiré par Ghibli, où de minuscules personnages joyeux travaillent ensemble pour récolter, couper, écraser et transformer une cerise rouge géante et brillante en jus de cerise frais et en confiture. Montrez la cerise s'écrasant sur une table en bois, les ouvriers construisant des échafaudages et des ponts avec des objets du quotidien, tranchant le fruit avec des outils surdimensionnés, collectant le jus qui s'écoule, tirant des chariots remplis de morceaux de cerise et applaudissant alors que l'atelier s'anime. Terminez par une vue large et magique des minuscules ouvriers célébrant autour d'une grande boîte en métal remplie de confiture de cerises rouge vif, avec un éclairage chaleureux, des textures détaillées, un travail d'équipe ludique et une charmante animation artisanale.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095084187367907328/img/qYAwALF9EVgltrYP.jpg" width="600" alt="Atelier miniature de cerises inspiré par Ghibli">

**[🎬 Voir la vidéo →](https://x.com/noorwithwifi/status/2095084419296182741)**

**Auteur:** [NoorAI](https://x.com/noorwithwifi) | **Source:** [Link](https://x.com/noorwithwifi/status/2095084419296182741) | **Publié:** Sep 2, 2026

---
### Vidéo ASMR de croissance d'une créature en gelée

![中文](https://img.shields.io/badge/lang-中文-red)

> Un prompt complet pour générer des vidéos ASMR de haute qualité mettant en scène une substance gélatineuse se transformant en une créature mignonne, incluant des étapes d'animation détaillées et une conception sonore.

#### 📝 Prompt

```
Générez une vidéo ASMR verticale complète et autonome de 10 secondes, format 9:16, 30 fps, plan macro studio ultra-réaliste fusionné avec un rendu CG de corps souple « cute » haut de gamme. Plan fixe en gros plan, vue en plongée aux trois quarts, aucun mouvement de caméra. Table de couleur bleu charbon mat, arrière-plan flou de la même couleur, faible profondeur de champ. Un éclairage studio principal puissant en haut à gauche crée des ombres nettes, des reflets rectangulaires lumineux et des réflexions de contact chaudes. Une main aux ongles longs et ovales exquis tient un tube souple de [couleur du tube] depuis le haut du cadre, révélant un embout fileté. La main presse lentement un gelée [couleur du matériau] épaisse, très visqueuse et brillante. Le gel doit rester connecté en continu à l'embout et se développer progressivement pour former un [animal] complet. Générez un seul animal. La structure corporelle se forme en continu selon la séquence de croissance réelle, sans apparition instantanée : 0,0–1,0 s : L'embout entre dans le cadre, une petite quantité de gel s'accumule sous l'embout. 1,0–3,5 s : Le gel s'étend vers le bas, formant la tête et le torse principal de l'animal. 3,5–6,0 s : Les membres, oreilles, ailes, nageoires, queues ou autres caractéristiques de l'espèce poussent en séquence, la couleur et la texture de la surface deviennent progressivement claires. 6,0–7,0 s : La forme de l'animal est entièrement terminée, le gel reliant l'embout est étiré en un filament élastique de plus en plus fin. 7,0–7,5 s : Le filament se rompt naturellement, la main et le tube sortent du cadre par le haut. 7,5–8,5 s : L'animal atterrit sur la table, subissant un écrasement doux, un rebond et un léger tremblement de gelée. 8,5–9,6 s : L'animal effectue un petit mouvement caractéristique de l'espèce : [mouvement signature]. 9,6–10,0 s : L'animal se stabilise au centre du cadre, conservant un état final complet, mignon, clair et héroïque, pratique pour une coupe franche vers le segment suivant. Maintenez une anatomie animale cohérente, un matériau stable et une quantité unique. Les reflets et les ombres doivent bouger naturellement avec le changement de forme. La déformation entière est un processus de croissance physique continu, sans utiliser de fondu, de flash ou de remplacement par occlusion. Conception sonore ASMR en micro rapproché : pressage lent de gel épais, étirement collant subtil, libération délicate d'un filament élastique, atterrissage sourd d'un corps souple, léger vacillement de gelée et minuscules sons de contact de surface. Son stéréo propre et intime, sans dialogue, sans narration, sans musique forte.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095070639887638528/img/BeW3NqKCNP7G-YSm.jpg" width="600" alt="Vidéo ASMR de croissance d'une créature en gelée">

**[🎬 Voir la vidéo →](https://x.com/GeekCatX/status/2095072409141629082)**

**Auteur:** [知识猫AI实验室](https://x.com/GeekCatX) | **Source:** [Link](https://x.com/GeekCatX/status/2095072409141629082) | **Publié:** Sep 2, 2026

---
### Prompts de production vidéo pour le porc braisé Hakka

![中文](https://img.shields.io/badge/lang-中文-red)

> Séquence incomplète de prompts pour une vidéo culinaire sur le porc braisé Hakka, couvrant la préparation des ingrédients et les étapes initiales de sautage avec des détails cinématographiques.

#### 📝 Prompt

```
Verrouillage de la cohérence uniforme : Verrouillage de la poitrine de porc : Utilisez toujours le même lot de poitrine de porc fraîche avec la peau. Les cubes doivent mesurer environ 2,5 à 3 cm de côté. Chaque morceau doit montrer clairement les couches de peau, de gras et de viande maigre. Ne doit pas se transformer en poulet, côtes, pieds de porc, viande purement maigre ou fines tranches. Seul le rétrécissement naturel après la saisie et le mijotage est autorisé ; aucun changement soudain de taille ou de forme. Une fois cuit, il doit être tendre et gélatineux tout en restant intact. Verrouillage des légumes conservés Hakka : Les légumes sont jaune pâle, jaune moutarde et légèrement jaune olive. Conservez les tiges courtes et épaisses, les feuilles larges et les fibres de saumure réalistes. Ne doit pas se transformer en légumes séchés noirs, haricots acides, moutarde hachée ou légumes verts frais. Verrouillage des champignons noirs : Ajoutez seulement une petite quantité de champignons noirs réhydratés brun foncé. Il s'agit d'un ingrédient secondaire qui ne doit pas éclipser le porc ou les légumes. Ne doit pas se transformer en champignons shiitake, varech ou algues. Verrouillage des ustensiles de cuisine : Les trois premiers segments utilisent toujours le même wok chinois rond noir avec deux poignées métalliques en forme d'oreilles. Utilisez la même spatule en bois large brun foncé. Utilisez le même couvercle en verre transparent pour le mijotage. Ne transférez dans la marmite en terre cuite noire de l'image de référence qu'au quatrième segment. Verrouillage de l'environnement : La même cuisine chinoise chaleureuse et propre. La même paire de mains de chef ; les mains sont naturelles et propres, aucun visage n'est montré. Les angles de caméra sont principalement en plongée et en gros plans à 45 degrés. Le plan final utilise une macro en contre-plongée à 3/4. Aucun sous-titre, texte, emballage, marque ou filigrane sur l'ensemble de la vidéo. Segment 1 : Générez une publicité culinaire Hakka réaliste et haut de gamme de 10 s, format vertical 9:16, montrant la préparation des ingrédients. Référez-vous aux formes de la poitrine de porc et des légumes ainsi qu'aux actions de découpe de la vidéo téléchargée, en recomposant le tout dans un cadre vertical cinématographique. 0-2 s : Plan macro d'une bande entière de poitrine de porc fraîche sur une planche à découper en bois massif brun rougeâtre. Présentez clairement la peau claire, le gras crémeux et les couches de viande maigre rosée. Zoom avant lent, la viande semble humide et fraîche, pas grise ou plastique. 2-5 s : Le chef utilise un couperet chinois pour découper le porc en cubes de 2,5 à 3 cm d'épaisseur. La coupe de la peau doit montrer une résistance réaliste. 5-7 s : Montrez les légumes Hakka conservés en train d'être lavés et essorés dans une bassine en acier inoxydable. Les couleurs sont jaune pâle/moutarde avec des rides naturelles. 7-9 s : Coupez les légumes en bandes courtes et épaisses et en morceaux irréguliers. 9-10 s : Plan en plongée de la préparation. À gauche : bol en acier inoxydable avec le porc ; à droite : légumes dorés ; à l'arrière : champignons noirs ; en bas : wok noir. Utilisez un éclairage latéral naturel et chaud, un objectif macro, une faible profondeur de champ. Prompts négatifs : Pas de viande cuite, de porc sans peau, de viande purement maigre, de côtes, de pieds de porc, de poulet, de bœuf, de viande hachée ou de fines tranches. Pas de légumes séchés noirs, de haricots acides, de légumes verts frais, de tofu, de taro, de pommes de terre, de piment rouge. Pas de couteaux déformés, de doigts supplémentaires, d'ingrédients flottants, de texte, de logos ou de filigranes. Segment 2 : Générez une publicité culinaire réaliste et haut de gamme de 10 s, format vertical 9:16, poursuivant dans le même environnement. 0-1 s : Commencez à partir de l'image finale précédente, le chef verse le porc cru dans le wok noir préchauffé. Pas d'eau ajoutée, pas de blanchiment. 1-4 s : Faites sauter avec la spatule en bois. Le porc passe du rose au crème pâle avec des bords dorés naturellement grillés et du saindoux fondu. Les couches restent claires. 4-5,2 s : Retirez le porc saisi dans un bol en acier inoxydable. Ne gardez qu'une fine couche de saindoux dans le wok. 5,2-7 s : Versez les légumes conservés. Faites sauter jusqu'à ce que l'humidité disparaisse et que les tiges soient légèrement brillantes, en conservant la couleur jaune doré. Retirez et mettez de côté. 7-8,2 s : Faites sauter le gingembre, l'ail et les échalotes dans le saindoux. 8,2-10 s : Ajoutez la sauce au tofu fermenté, la pâte de soja et le douchi. Faites sauter pour obtenir une base uniforme brun rougeâtre châtain. Figez sur la base de sauce parfumée avec le porc saisi et les légumes sur le côté. Prompts négatifs : Pas de blanchiment, pas de friture, pas d'éclaboussures d'huile excessives, pas de flammes entourant le wok, pas de fumée épaisse ou de viande brûlée. La viande ne doit pas être entièrement cuite ou perdre sa peau. Pas d'ajout précoce de légumes, pas de poudre de levure rouge, d'anis étoilé, de cannelle ou de piment. Segment 3 : Générez une publicité culinaire Hakka réaliste et haut de gamme de 10 s, format vertical 9:16. 0-2 s : Remettez le porc dans la base de sauce avec les champignons noirs. Faites sauter jusqu'à ce que chaque morceau soit finement enrobé de sauce brun rougeâtre. La forme de la viande ne doit pas changer. 2-3,3 s : Versez du vin de Shaoxing le long de la paroi intérieure. Brève vapeur naturelle, pas de flammes. 3,3-5 s : Ajoutez de l'eau chaude jusqu'à couvrir 2/3 à 4/5 de la viande. Remuez une fois pour dissoudre la sauce dans le bouillon. 5-6,5 s : Le liquide atteint un frémissement stable avec de petites bulles. Pas d'ébullition violente ou de débordement. 6,5-7,5 s : Couvrez avec le couvercle en verre transparent assorti. L'intérieur du verre forme une condensation naturelle. 7,5-10 s : Utilisez une compression temporelle fluide pour montrer le mijotage pendant 40 minutes. Les ustensiles de cuisine et la cuisinière restent immobiles. La viande est légèrement visible à travers la vapeur. Prompts négatifs : N'ajoutez pas de légumes, ne changez pas d'ustensiles de cuisine, n'utilisez pas d'autocuiseur. Pas d'ébullition violente, d'eau grise ou d'huile flottante épaisse. Le porc ne doit pas disparaître, se casser ou se transformer en poulet. Segment 4 : Générez une publicité culinaire Hakka réaliste et haut de gamme de 10 s, format vertical 9:16. Utilisez la dernière image du Segment 3 pour la continuité et la photo de référence pour la marmite en terre cuite noire finale, le dressage, la couleur et le plan héroïque. Ne copiez pas les bordures, le texte ou les graphiques de la référence. 0-1,2 s : Le chef retire le couvercle en verre. La vapeur monte et se dissipe, révélant le porc intact brun châtain. 1,2-2,8 s : Versez les légumes sautés. 2,8-4,5 s : Faites sauter pour réduire la sauce. La sauce devient un glaçage rouge-orange enrobant la viande et les légumes. 4,5-5,8 s : Transférez dans une marmite en terre cuite ronde noir charbon mat avec un bord épais. 5,8-6,8 s : Placez les légumes au fond, puis empilez 12-16 cubes de porc au centre. Un morceau brillant et net au centre devant. 6,8-7,3 s : Arrosez de sauce rouge-orange concentrée et saupoudrez de 10-15 oignons verts. 7,3-10 s : Transition vers un plan héroïque en contre-plongée à 3/4. La marmite occupe les 2/3 inférieurs du cadre. La sauce est rouge-orange/caramel/rouge doré à haute saturation avec des ombres châtain. Lumière principale chaude venant du haut à gauche, arrière-plan gris foncé et doucement flouté. Zoom avant minimal, la nourriture reste stable pendant les 3 dernières secondes. Le porc doit paraître réaliste avec la peau, le gras et la fibre. Prompts négatifs : Pas de bordures, d'étiquettes rouges, de caractères chinois ou de filigranes. Pas d'assiettes blanches, d'acier inoxydable ou de marmites de couleur claire. Pas de poulet, de côtes, de tranches de viande ou de viande hachée. Pas de légumes noirs, de haricots acides, de légumes verts, de tofu, de taro, de pommes de terre, de piment, de coriandre ou de sésame. Pas de sauce noire ou violette, de soupe aqueuse ou de filaments sirupeux. Pas de viande piquée ou déplacée dans les 3 dernières secondes.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094974143213051904/img/iDFO8PNXfCcmDA-T.jpg" width="600" alt="Prompts de production vidéo pour le porc braisé Hakka">

**[🎬 Voir la vidéo →](https://x.com/7998l201/status/2094975000763584583)**

**Auteur:** [Ryan](https://x.com/7998l201) | **Source:** [Link](https://x.com/7998l201/status/2094975000763584583) | **Publié:** Sep 2, 2026

---
### Storyboard pour publicité d'eau de coco

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de storyboard complet pour une publicité d'eau de coco premium, détaillant les scènes cinématographiques, les mouvements de caméra et le stylisme du produit.
...
4. Liquide clair tourbillonnant dans le verre avec de minuscules bulles
...
7. Macro extrême de gouttes de condensation coulant le long de la bouteille
8. Bouteille et verre mis en valeur, entourés de morceaux de noix de coco fraîche et d'une éclaboussure d'eau glacée
...
CAMÉRA :
Photographie liquide haute vitesse, macro extrême, gros plan sur la condensation, chute de glace au ralenti, tourbillon de liquide transparent, prise de vue du produit en contre-plongée, cadrage cinématographique du produit phare.
...
<img src="https://cms-assets.youmind.com/media/1788857253380_cr9h8y_HRIV2OMWEAAdkxS.jpg" width="600" alt="Storyboard pour publicité d'eau de coco">

**[🎬 Voir la vidéo →](https://x.com/Strength04_X/status/2094760813794111843)**

**Auteur:** [𝐌](https://x.com/Strength04_X) | **Source:** [Link](https://x.com/Strength04_X/status/2094760813794111843) | **Publié:** Sep 1, 2026
...
> Un prompt de génération vidéo pour Gemini Omni permettant de créer un hyperlapse cinématographique d'un personnage visitant plusieurs monuments chinois tout en conservant une cohérence faciale.

#### 📝 Prompt

```
Créez un hyperlapse selfie de 10 secondes en utilisant le personnage téléchargé, visitant 20 monuments chinois avec une coupe franche sur chaque temps. Maintenez exactement le même visage tout au long de la vidéo. Perspective grand angle type perche à selfie, avec une tenue de style local différente pour chaque lieu. Haute définition avec un étalonnage des couleurs cinématographique riche.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094290992283140096/img/MaogORzgUA2lkwi6.jpg" width="600" alt="Hyperlapse selfie devant des monuments chinois">
...
> Un prompt publicitaire dynamique et rapide pour une barre chocolatée au café, mettant en scène des éclaboussures spectaculaires et des révélations de produit percutantes.

#### 📝 Prompt

```
Créez une publicité cinématographique au rythme effréné pour la barre chocolatée Bloodline Coffee Chocolate Bar, avec des éclaboussures de chocolat spectaculaires, des grains de café torréfiés en suspension et des gros plans dynamiques. Révélez l'élégant emballage noir et or, puis montrez la barre qui se brise pour exposer un caramel fondant et un intérieur riche en chocolat. Mettez le produit en valeur sur une scène réfléchissante sous un éclairage chaleureux, suivi d'un jeune homme savourant une bouchée alors que des grains de café flottent autour de lui. Terminez avec la barre chocolatée traversant un tourbillon de chocolat et de café, pour une transition vers le logo de la marque et le slogan final : « UNLEASH YOUR ENERGY ».
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094217152052310016/img/ualHsMCVJmD521b7.jpg" width="600" alt="Publicité cinématographique pour chocolat au café">

**[🎬 Voir la vidéo →](https://x.com/AiwithBloodline/status/2094217190321123331)**

**Auteur:** [Dr Bloodline | AI](https://x.com/AiwithBloodline) | **Source:** [Link](https://x.com/AiwithBloodline/status/2094217190321123331) | **Publié:** Aug 31, 2026

---
### Monde de construction de pizzas miniatures

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt d'animation ludique inspiré de Pixar représentant de minuscules ouvriers construisant une pizza à l'aide de chargeuses, de grues et de tapis roulants.

#### 📝 Prompt

```
{  "video_duration": "10 secondes",  "aspect_ratio": "16:9",  "sequence": [    {      "time": "0-2 sec",      "scene": "Mise en place grandiose",      "camera": "Plan large aérien cinématographique avec zoom avant",      "action": "Une énorme pizza fraîchement sortie du four repose sur une table en bois telle un immense chantier de construction. Des dizaines de minuscules ouvriers arrivent en courant avec des chargeuses, des grues, des camions de livraison et du matériel miniatures, se préparant à construire la pizza parfaite.",      "sound_design": "Musique joyeuse et ludique, bruits de petits moteurs, roulement de roues, activité de chantier subtile."    },    {      "time": "2-4 sec",      "scene": "Couche de sauce et de fromage",      "camera": "Plan moyen en travelling latéral",      "action": "Un camion de nourriture miniature pompe une riche sauce tomate rouge sur la pizza tandis que de minuscules ouvriers l'étalent uniformément avec de petites spatules. Une autre équipe suit derrière, recouvrant la surface d'une épaisse couche de mozzarella râpée.",      "sound_design": "Son doux de sauce versée, raclement de spatule, bruissement de fromage, musique rythmique joyeuse."    },    {      "time": "4-6 sec",      "scene": "Ingrédients en mouvement",      "camera": "Gros plan macro avec léger ralenti",      "action": "Des tapis roulants miniatures transportent des ingrédients colorés, notamment du pepperoni, des champignons, des poivrons, des olives et du basilic frais. Les ouvriers miniatures disposent soigneusement chaque ingrédient sur la surface fromagère avec précision.",      "sound_design": "Mouvement de tapis roulant, petits bruits de chute d'ingrédients, carillons magiques délicats, accents musicaux entraînants."    },    {      "time": "6-8 sec",      "scene": "Pose de l'ingrédient final",      "camera": "Plan cinématographique dramatique en contre-plongée",      "action": "Une grue miniature soulève une tranche de pepperoni surdimensionnée vers le centre de la pizza. Les ouvriers en contrebas tirent sur des cordes de guidage et se font signe alors que l'ingrédient est lentement mis en place.",      "sound_design": "Petit moteur de grue, sons de tension de corde, clics mécaniques, musique orchestrale cinématographique montante."    },    {      "time": "8-10 sec",      "scene": "Grand final de la pizza",      "camera": "Gros plan fluide en orbite à 360 degrés",      "action": "L'ingrédient final tombe parfaitement en place. Une explosion de confettis colorés remplit le monde miniature tandis que les minuscules ouvriers acclament et célèbrent. La caméra balaie la pizza terminée, révélant son fromage fondu brillant, ses garnitures colorées et sa croûte dorée avant de terminer sur un plan héroïque satisfaisant.",      "sound_design": "Pop de célébration, acclamations joyeuses, petits sifflets, final orchestral exaltant."    }  ],  "visual_style": {    "animation_quality": "Animation 3D premium inspirée de Pixar",    "world_design": "Charmant monde de construction miniature bâti autour d'une pizza surdimensionnée",    "color_palette": "Rouges chauds, bruns dorés, tons de fromage crémeux et garnitures aux couleurs vives",    "lighting": "Éclairage chaud et doux avec de légers reflets cinématographiques",    "detail": "Textures alimentaires très détaillées, machinerie miniature, fonte réaliste du fromage, garnitures croustillantes et minuscules personnages expressifs",    "camera": "Mouvement cinématographique fluide, sensation de photographie macro, transitions fluides, faible profondeur de champ",    "overall_feel": "Mignon, ludique, visuellement satisfaisant, soigné, premium et fantaisiste",    "resolution": "720p"  }}
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094160586024325120/img/J_HWGth3nosxOM4L.jpg" width="600" alt="Monde de construction de pizzas miniatures">

**[🎬 Voir la vidéo →](https://x.com/SaasJunctionHQ/status/2094160643138154730)**

**Auteur:** [SaaS Junction ✦ Daily AI News & Prompts](https://x.com/SaasJunctionHQ) | **Source:** [Link](https://x.com/SaasJunctionHQ/status/2094160643138154730) | **Publié:** Aug 30, 2026

---
### Flexion en salle de sport : Image vers vidéo

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt utilisant une photo de référence pour animer une personne qui tourne la tête et contracte son bras tout en conservant la cohérence du personnage.

#### 📝 Prompt

```
En utilisant l'image de référence, faites-la tourner lentement la tête vers la caméra. Ses cheveux noirs ébouriffés bougent ; elle cligne des yeux, puis contracte un bras tout en gardant sa pose. Conservez son visage et sa tenue de sport à l'identique. Lent zoom avant cinématographique.
```

<img src="https://cms-assets.youmind.com/media/1788170323705_xefihp_HQ-avR2XsAAURe8.jpg" width="600" alt="Flexion en salle de sport : Image vers vidéo">

**[🎬 Voir la vidéo →](https://x.com/amynys/status/2094107886008107062)**

**Auteur:** [Amy G](https://x.com/amynys) | **Source:** [Link](https://x.com/amynys/status/2094107886008107062) | **Publié:** Aug 30, 2026

---
### Séquence d'assemblage d'intérieur cinématographique

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt cinématographique détaillé qui anime l'assemblage de l'intérieur d'un appartement moderne, avec des meubles et du matériel audio qui se matérialisent sous la lumière du soleil.

#### 📝 Prompt

```
Un plan cinématographique continu de 10 secondes sans aucune coupure, caméra fixe grand angle, aucun mouvement de caméra. Appartement moderne vide hyper-réaliste avec des murs blancs épurés, de grandes baies vitrées, du parquet poli et une belle hauteur sous plafond. Une lumière dorée et chaleureuse d'après-midi traverse les fenêtres, projetant des ombres douces et mouvantes. Aucun texte visible, à l'exception de la marque Bose authentique sur le matériel audio. De 0 à 1,5 s, une élégante boîte noir mat est posée au centre de la pièce vide, tremble légèrement, puis s'ouvre en douceur. De 1,5 à 3,5 s, une barre de son Bose se fixe sur le mur de gauche et commence à diffuser une musique d'ambiance douce ; une paire d'enceintes sans fil Bose assorties flottent vers les coins opposés et se synchronisent. De 3,5 à 5,5 s, un canapé moelleux aux tons neutres se déploie au centre tandis qu'un tapis tissé à la main aux tons terreux se déroule en dessous. De 5,5 à 7,5 s, des étagères minimalistes en bois s'élèvent le long du mur de droite et se remplissent de livres et d'objets sélectionnés ; des vases en céramique et des plantes d'intérieur luxuriantes apparaissent dans les coins ; des suspensions modernes descendent du plafond et diffusent une lueur chaleureuse. De 7,5 à 9 s, une élégante table basse en marbre se matérialise devant le canapé, une décoration murale abstraite aux couleurs douces apparaît sur le mur du fond, et un petit thermostat intelligent s'installe. La dernière seconde se fige sur l'appartement terminé, confortable et élégamment décoré, baigné par la lumière chaude du soleil, avec le système Bose diffusant une mélodie apaisante. Physique photoréaliste, assemblage précis, chaleur moderne et élégante.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094046860726169602/img/fR9t1C1DTQ9ymg5M.jpg" width="600" alt="Séquence d'assemblage d'intérieur cinématographique">

**[🎬 Voir la vidéo →](https://x.com/MrDasOnX/status/2094046957270684064)**

**Auteur:** [Mr Das](https://x.com/MrDasOnX) | **Source:** [Link](https://x.com/MrDasOnX/status/2094046957270684064) | **Publié:** Aug 30, 2026

---
### Galaxie du flux de connaissances des LLM

![English](https://img.shields.io/badge/lang-English-blue)

> Une visualisation conceptuelle des grands modèles de langage où la logique interne et le flux de données sont représentés sous la forme d'une galaxie céleste avec une comète traversant les étoiles.

#### 📝 Prompt

```
Générez une vidéo de 10 secondes sur le flux des LLM représenté sous forme de galaxie. La galaxie représente l'espace multidimensionnel, les étoiles symbolisent vos poids/connaissances/vecteurs intégrés, et un passage unique est représenté par une comète qui traverse certaines de ces étoiles. Faites en sorte que la comète soit petite, semblable à une lumière traversant les étoiles dans des directions aléatoires. La comète doit partir de la gauche du groupe d'étoiles et se terminer sur la partie droite du point de vue de l'utilisateur dans la vidéo.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093993625344499712/img/dN2u8XS4s8amSPTW.jpg" width="600" alt="Galaxie du flux de connaissances des LLM">

**[🎬 Voir la vidéo →](https://x.com/TunducR/status/2093993994439033148)**

**Auteur:** [Tunduc Raul](https://x.com/TunducR) | **Source:** [Link](https://x.com/TunducR/status/2093993994439033148) | **Publié:** Aug 30, 2026

---
### Animation de broderie du logo Gemini Omni

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt cinématographique macro détaillé pour Gemini Omni 1.1 permettant de créer une animation de fils colorés se tissant pour former un logo sur un tissu en coton.

#### 📝 Prompt

```
Plan macro extrême d'un tissu de chemise en coton tissé, vide au départ. Des fils de broderie colorés surgissent de la surface et s'entrelacent pour se mettre en place, formant des points de satin serrés rangée par rangée, dessinant ainsi le logo.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093992072185581568/img/RCUiHx5O1oeKNf6s.jpg" width="600" alt="Animation de broderie du logo Gemini Omni">

**[🎬 Voir la vidéo →](https://x.com/SJinn_Agent/status/2093993109361426766)**

**Auteur:** [SJinn Agent](https://x.com/SJinn_Agent) | **Source:** [Link](https://x.com/SJinn_Agent/status/2093993109361426766) | **Publié:** Aug 30, 2026

---
### Montage réseaux sociaux style « Kawaii Sticker Bomb »

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de génération vidéo pour créer un clip viral style réseaux sociaux mettant en scène une femme faisant un signe de paix, agrémenté d'autocollants animés et de superpositions de texte kawaii.

#### 📝 Prompt

```
Montage réseaux sociaux ultra-mignon et viral. La femme faisant le signe de paix sourit tandis que la caméra zoome doucement. La vidéo est recouverte d'un effet « sticker bomb » : étoiles scintillantes animées, cœurs rebondissants et superpositions de texte « KAWAII » qui pulsent au rythme de la musique.
```

<img src="https://cms-assets.youmind.com/media/1788170325072_1r4e7y_HQ9OAh7aAAAJ-Cl.jpg" width="600" alt="Montage réseaux sociaux style « Kawaii Sticker Bomb »">

**[🎬 Voir la vidéo →](https://x.com/CrazyKaomei/status/2093992934358286350)**

**Auteur:** [疯狂的烤妹儿 🩵](https://x.com/CrazyKaomei) | **Source:** [Link](https://x.com/CrazyKaomei/status/2093992934358286350) | **Publié:** Aug 30, 2026

---
### Cinéma de drift agressif dans le désert

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt cinématographique automobile axé sur le drift à haute vitesse dans des dunes dorées, avec un suivi de caméra dramatique et des prises de vue en POV.
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2093957432380940288/img/gaSPtVaytRj2YWif.jpg" width="600" alt="Cinéma de drift agressif dans le désert">

**[🎬 Voir la vidéo →](https://x.com/itsSSS1510/status/2093957642444292264)**

**Auteur:** [Sheetal Shinde](https://x.com/itsSSS1510) | **Source:** [Link](https://x.com/itsSSS1510/status/2093957642444292264) | **Publié:** Aug 30, 2026
...
> Une séquence cinématographique d'animation 3D riche en action mettant en scène une protagoniste sur une moto aux accents néon, tentant d'échapper à une horde de zombies.
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2093925475324510208/img/v_VZ8mF6rGkOv_5Y.jpg" width="600" alt="Course-poursuite futuriste à moto contre des zombies">

**[🎬 Voir la vidéo →](https://x.com/AiwithBloodline/status/2093925571311051143)**

**Auteur:** [Dr Bloodline | AI](https://x.com/AiwithBloodline) | **Source:** [Link](https://x.com/AiwithBloodline/status/2093925571311051143) | **Publié:** Aug 30, 2026

---
### Animation de l'anime Chisato Nishikigi

![日本語](https://img.shields.io/badge/lang-日本語-green)

> Un prompt d'animation pour Gemini Omni 1.1 Flash mettant en scène Chisato Nishikigi de Lycoris Recoil, criant des phrases de motivation dans un environnement scolaire.

#### 📝 Prompt

```
Créez une vidéo d'animation de Chisato Nishikigi de Lycoris Recoil, avec un visage sérieux à l'intérieur de l'école, criant : « Ça ne sert à rien de s'inquiéter pour des choses qu'on ne peut pas contrôler ! », « Accepte-le, donne tout ce que tu as ! » et « C'est généralement à ce moment-là que de bonnes choses arrivent ».
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093832991349039104/img/P3M3vM1hpfhHcF_-.jpg" width="600" alt="Animation de l'anime Chisato Nishikigi">

**[🎬 Voir la vidéo →](https://x.com/secondenalist/status/2093833007178436988)**

**Auteur:** [兼業エナリスト](https://x.com/secondenalist) | **Source:** [Link](https://x.com/secondenalist/status/2093833007178436988) | **Publié:** Aug 29, 2026

---
### Vidéo publicitaire pour soins de la peau est-asiatiques

![中文](https://img.shields.io/badge/lang-中文-red)

> Un prompt vidéo cinématographique pour une publicité de soins de la peau haut de gamme, mettant en avant des détails macro de la peau, un mouvement organique élégant et une esthétique minimaliste.

#### 📝 Prompt

```
Gros plan macro extrême sur les yeux d'une femme est-asiatique, peau hydratée, lumière naturelle spectaculaire projetant des ombres nettes sur son visage. Coupe directe vers un plan moyen en contre-plongée, tourné en extérieur sous un ciel bleu éclatant, la femme se tient entre des rideaux en tissu blanc translucide et fluide, tendant un tube de crème solaire coréenne beige minimaliste directement vers l'objectif. Coupe vers un super gros plan macro où elle applique délicatement la crème blanche sur ses pommettes. Mouvement organique doux, draperie blanche fine flottant dans la brise, ombres de fenêtre artistiques dansant sur sa peau hydratée semblable à du verre. Esthétique publicitaire de soins de la peau coréens minimaliste, texture de peau ultra-détaillée, éclairage de studio élégant, serein et luxueux, lumière naturelle à fort contraste, tons chauds cinématographiques, résolution 8K, réaliste et fidèle à la vie, 24 fps.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093726929086214144/img/CvDq4auc7HWLhePT.jpg" width="600" alt="Vidéo publicitaire pour soins de la peau est-asiatiques">

**[🎬 Voir la vidéo →](https://x.com/GeekCatX/status/2093727235262075091)**

**Auteur:** [知识猫AI实验室](https://x.com/GeekCatX) | **Source:** [Link](https://x.com/GeekCatX/status/2093727235262075091) | **Publié:** Aug 29, 2026

---
### Animation de broderie de logo en macro

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt spécialisé en timelapse macro qui anime le tissage d'un fil pour former un logo de marque sur du tissu, avec des textures et un éclairage réalistes.

#### 📝 Prompt

```
« Plan macro extrême d'un tissu de chemise en coton, vide au départ. Des fils à broder colorés surgissent de la surface et s'entrelacent pour se mettre en place, formant des points de satin serrés rangée par rangée, dessinant le logo téléchargé. La zone brodée s'agrandit progressivement dans le cadre, le fil se tend et prend du relief jusqu'à ce que le logo complet soit terminé. Caméra fixe, rythme de timelapse lent et satisfaisant. Éclairage latéral naturel et doux, faible profondeur de champ, fibres de tissu visibles et éclat réaliste du fil. Pas de mains, le fil bouge tout seul. Plan unique, aucun changement de scène. »
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093672520440246272/img/4hzIWVYpdKZg9p_D.jpg" width="600" alt="Animation de broderie de logo en macro">

**[🎬 Voir la vidéo →](https://x.com/codecloude/status/2093672581907742963)**

**Auteur:** [Code cloud E.commerce | کد کلاد](https://x.com/codecloude) | **Source:** [Link](https://x.com/codecloude/status/2093672581907742963) | **Publié:** Aug 29, 2026

---
### Présentation structurée du produit Nescafé

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt technique au format JSON pour une publicité professionnelle sur le café, illustrant une plantation se transformant en un pot de produit.
...
```
{
  ...
  "shot": {
    "structure": "plan-séquence unique et continu, sans coupure",
    "composition": "démarre en plan ultra-large sur une plantation de café ensoleillée, suit des grains s'élevant en un tourbillon dans les airs, se termine sur un gros plan centré d'un pot Nescafé en lévitation",
    "lens": "téléobjectif pour les rangées de la plantation, puis 35 mm pour la révélation du produit",
    "frame_rate": "24 fps cinématique",
    "camera_movement": "montée lente suivant les grains en tourbillon, puis travelling avant fluide alors qu'ils se verrouillent en forme de pot, maintien stable sur le produit en lévitation"
  },
  "timeline": {
    "0-3s": "Plantation de café sur une colline à l'heure dorée, en plan ultra-large. Grains de café torréfiés éparpillés sur le sol entre les rangées de plantes. Soleil chaud de fin d'après-midi, longues ombres douces, brise légère dans les feuilles.",
    "3-7s": "Les grains s'élèvent du sol et tournent en spirales lentes, élégantes et organisées. Ils s'imbriquent dans les airs pour former la silhouette exacte d'un pot de café premium. Turbulence de particules subtile et bords des grains lumineux.",
    "7-10s": "La forme composée de grains pulse une fois et se transforme en un véritable pot de café Nescafé flottant en apesanteur, centré dans le cadre. Maintien sur le produit. Lumière dorée sur les contours."
  },
  "subject": {
    "description": "des centaines de grains de café torréfiés s'élevant et tournoyant en spirales élégantes pour former la silhouette d'un pot de café premium",
    "props": "pot de café Nescafé final formé à partir des grains tourbillonnants, puis transition vers un emballage de marque réel tout en flottant dans les airs"
  },
  "scene": {
    "location": "plantation de café sur une colline ouverte",
    "time_of_day": "fin d'après-midi, heure dorée, soleil bas, longues ombres",
    "environment": "brise chaude, ombres douces sur les rangées de la plantation, grains épars dans l'air"
  },
  "visual_details": {
    "action": "les grains s'élèvent, tournent en spirales organisées, se verrouillent en contour de pot, pulsent, puis se transforment en emballage Nescafé fini suspendu dans l'espace",
    "special_effects": "animation de particules de grains, turbulence au ralenti, morphing de matière dans les airs, scintillement subtil de lévitation"
  },
  "cinematography": {
    "lighting": "lumière du soleil directionnelle et chaude, bords des grains lumineux, lumière dorée sur les contours du pot flottant",
    "color_palette": "bruns riches, noirs profonds, ors ambrés, verts terreux",
    "tone": "naturel, sophistiqué, élégance premium"
  },
  "audio": {
    "music": "guitare acoustique douce avec percussions légères et envolées de piano ambiant",
    "ambient": "feuilles qui bruissent, oiseaux au loin, brise à travers les rangées de café",
    "sound_effects": "montée en puissance du tourbillon de grains, clic de verrouillage lorsque la forme est complète, bourdonnement subtil sous la lévitation",
    "mix": "aérien, ouvert, axé sur la nature avec un centre musical chaleureux"
  },
  "constraints": {
    "dialogue": "aucun",
    "voiceover": "aucun",
...
<img src="https://pbs.twimg.com/amplify_video_thumb/2093639810439364608/img/xIwz_L8uOYOcvixG.jpg" width="600" alt="Présentation structurée du produit Nescafé">

**[🎬 Voir la vidéo →](https://x.com/MrDasOnX/status/2093639917226311970)**

**Auteur:** [Mr Das](https://x.com/MrDasOnX) | **Source:** [Link](https://x.com/MrDasOnX/status/2093639917226311970) | **Publié:** Aug 29, 2026

---
### Scène d'action : explosion d'une cafetière

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt riche en action mettant en scène une explosion, la physique des débris et l'interaction des personnages dans un environnement aux néons.

#### 📝 Prompt

```
la cafetière explose, les débris se déposent sur les costumes des détectives et l'enseigne néon « OPEN » projette sa lumière. Ensuite, transition vers l'équipe de déminage.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093577406409793536/img/DAV6eWZiwc3SnNIs.jpg" width="600" alt="Scène d'action : explosion d'une cafetière">

**[🎬 Voir la vidéo →](https://x.com/machina9000/status/2093577478941929615)**

**Auteur:** [Daniił Vołkaū](https://x.com/machina9000) | **Source:** [Link](https://x.com/machina9000/status/2093577478941929615) | **Publié:** Aug 29, 2026

---
### Script publicitaire pour le robot Chrome

![English](https://img.shields.io/badge/lang-English-blue)

> Un script complexe multi-scènes pour un personnage de robot au style années 90, incluant des cartons de titre, des contraintes de mouvement et des dialogues synchronisés.

#### 📝 Prompt

```
Tout au long du spot : un robot en costume pratique des années 90, chrome et caoutchouc, plaque pectorale indiquant « OMNI 1.1 »,
Le même robot. Dans chaque plan. Ne pas changer cela.

[0-1s] Carton de titre urgent et audacieux :
« JUSTE ARRIVÉ DE CHEZ GOOGLE ! »

[1-5s] Le robot reste immobile sur un fond sombre et épuré. 
Des cartons de titre chromés haut de gamme apparaissent un par un :

« JUSQU'À 4K. »
« EXTENSION JUSQU'À 10 SECONDES. »
« 2 PHOTOS → 1 VIDÉO. »
« 3 CLIPS. RESTE COHÉRENT. »

Le même robot. Il ne bouge pas. Il ne change pas.

[5-10s] COUPE VERS : Dojo façon Matrix. Le même robot. Aucun changement de costume.
Un enfant se tient en face de lui, l'air sérieux.

Enfant : « Tu connais le kung-fu ? »
Omni donne un coup de poing. Omni ramène sa main.
Omni dit « Aïe. »
Pause.
Omni dit « J'y travaille, gamin. »

Carton final : « GEMINI OMNI 1.1 »

Audio : jingle d'actualité à l'ouverture. Silence sous les cartons de fonctionnalités.
Montée en puissance de la musique de Matrix lors de la coupe au dojo. Coup de poing. Silence. « Aïe. »
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093563402916667392/img/JzOGeTSe5sUvg5s1.jpg" width="600" alt="Script publicitaire pour le robot Chrome">

**[🎬 Voir la vidéo →](https://x.com/BrentLynch/status/2093563415730258318)**

**Auteur:** [Brent Lynch](https://x.com/BrentLynch) | **Source:** [Link](https://x.com/BrentLynch/status/2093563415730258318) | **Publié:** Aug 29, 2026

---
### Publicité pour une chocolaterie miniature

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt vidéo de 10 secondes extrêmement détaillé pour une chocolaterie miniature photoréaliste, mettant en scène de minuscules ouvriers et un processus de production étape par étape.

#### 📝 Prompt

```
Créez une vidéo cinématographique ultra-réaliste de 10 secondes représentant une chocolaterie miniature. Montrez une minuscule usine de production de chocolat animée, gérée par d'adorables ouvriers miniatures portant des uniformes blancs professionnels, des charlottes et de minuscules tabliers.

0–2 sec : Les ouvriers miniatures versent avec soin du chocolat fondu onctueux depuis une grande cuve en acier inoxydable dans de petits moules sur un tapis roulant, avec de la vapeur réaliste et une texture de chocolat brillante.

2–4 sec : Les moules à chocolat traversent un tunnel de refroidissement miniature. Les ouvriers inspectent chaque pièce avec de minuscules outils et des loupes.

4–6 sec : Les ouvriers décorent les chocolats finis avec des noix, des filets de caramel, un nappage au chocolat et de minuscules vermicelles colorés à l'aide de machines miniatures et d'outils de précision.

6–8 sec : Un tapis roulant rapide transporte des chocolats parfaitement formés vers la station d'emballage. Les minuscules ouvriers placent chaque chocolat dans des emballages élégants et de petites boîtes.

8–10 sec : Plan final héroïque — des dizaines de chocolats magnifiquement emballés défilent sur le tapis roulant tandis que les ouvriers miniatures inspectent fièrement la ligne de production. La caméra avance lentement vers une boîte de chocolats parfaitement finie.

Style : monde miniature photoréaliste, photographie macro cinématographique, fonte et coulage du chocolat réalistes, machinerie miniature très détaillée, mouvements naturels des ouvriers, faible profondeur de champ, éclairage chaleureux de chocolaterie de luxe, reflets réalistes, vapeur subtile, mouvement de caméra fluide, atmosphère de production satisfaisante de type ASMR, qualité publicitaire premium, 4K, textures physiquement précises, aucun aspect cartoon.

Caméra : gros plans macro, travellings fluides, perspectives en contre-plongée, transitions fluides, profondeur de champ cinématographique.

Important : Gardez les mêmes ouvriers miniatures, la même disposition de l'usine, l'apparence du chocolat et le style visuel tout au long de la séquence de 10 secondes. Pas de texte, pas de logos, pas de mains déformées, pas de membres supplémentaires, pas de scintillement, pas de coupes abruptes.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093541345403224065/img/MdHVgd5_LknOet9K.jpg" width="600" alt="Publicité pour une chocolaterie miniature">

**[🎬 Voir la vidéo →](https://x.com/AiwithBloodline/status/2093541403796353389)**

**Auteur:** [Dr Bloodline | AI](https://x.com/AiwithBloodline) | **Source:** [Link](https://x.com/AiwithBloodline/status/2093541403796353389) | **Publié:** Aug 29, 2026

---
### Petit garçon de 4 ans streameur de jeu de zombies

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt pour générer une vidéo d'un petit garçon de 4 ans en train de streamer une session de jeu. Le jeu met en scène une infirmière combattant des zombies avec des seringues, et le modèle a pour instruction de parler en portugais.

#### 📝 Prompt

```
Un petit garçon de 4 ans streameur commentant et jouant à un jeu dont le personnage principal est une infirmière combattant des zombies avec une seringue. Le garçon est joint pour référence. Parler en portugais.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093506685738336256/img/bizbnu_Y4olNg2jx.jpg" width="600" alt="Petit garçon de 4 ans streameur de jeu de zombies">

**[🎬 Voir la vidéo →](https://x.com/gudesouzalima/status/2093506705996796413)**

**Auteur:** [Gustavo de Souza](https://x.com/gudesouzalima) | **Source:** [Link](https://x.com/gudesouzalima/status/2093506705996796413) | **Publié:** Aug 29, 2026

---
### Face-à-face crépusculaire : Ninja dans le désert

![English](https://img.shields.io/badge/lang-English-blue)

> Une scène cinématique de 10 secondes dans le désert mettant en scène un face-à-face au coucher du soleil entre un ninja masqué et trois guerriers, basée sur des images de référence pour le design des personnages.

#### 📝 Prompt

```
Utilisez les images téléchargées comme références visuelles pour les personnages. Créez une scène cinématique en prises de vues réelles de 10 secondes dans un désert au coucher du soleil. Un ninja masqué se tient seul face à trois guerriers sombres situés à quelques mètres. Utilisez l'Image 2 comme référence visuelle pour le ninja masqué. Utilisez l'Image 1 comme inspiration pour les trois guerriers adverses, en veillant à ce qu'ils soient trois personnages distincts issus de la même faction. Tout le monde doit rester immobile, concentré sur les autres. Le vent déplace doucement la poussière à travers le désert. Mouvement subtil des tissus. Forte tension cinématique. Le guerrier principal regarde le ninja et dit : « Tu es venu seul. » Le ninja le regarde calmement en retour et répond : « Je suis venu pour toi. » Maintenez le silence un instant après la réponse. Pas de combat. Pas d'attaque. Aucun mouvement d'épée. Aucun contact physique. Aucune blessure. Aucune violence. Réalisme cinématique, langage corporel naturel, synchronisation labiale réaliste, mouvement de caméra subtil, lumière dramatique de coucher de soleil, atmosphère désertique authentique.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093385776910221312/img/UaTv2dFJc0O_n79Y.jpg" width="600" alt="Face-à-face crépusculaire : Ninja dans le désert">

**[🎬 Voir la vidéo →](https://x.com/shikoba_86/status/2093446020499943538)**

**Auteur:** [Marco "Shikoba" Riccetti](https://x.com/shikoba_86) | **Source:** [Link](https://x.com/shikoba_86/status/2093446020499943538) | **Publié:** Aug 28, 2026

---
### Danse en plan-séquence pour MV de K-Pop

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de caméra haute vitesse pour créer un plan-séquence continu dans le style d'un clip de K-pop, mettant l'accent sur le charisme du danseur.

#### 📝 Prompt

```
[# Références <IMAGE_REF_0>@Image1 <IMAGE_REF_1>@Image2 <IMAGE_REF_2>@Image3] Strictement un seul plan-séquence continu et ininterrompu (zéro coupure). Mouvement de caméra haute vitesse typique des MV de K-pop, centré sur le haut du corps du danseur et son charisme facial, avec une dynamique en pied.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093441543726133248/img/SbUC1IZDPZuNWs_n.jpg" width="600" alt="Danse en plan-séquence pour MV de K-Pop">

**[🎬 Voir la vidéo →](https://x.com/Tomw852/status/2093441641571131816)**

**Auteur:** [Tom𝕎](https://x.com/Tomw852) | **Source:** [Link](https://x.com/Tomw852/status/2093441641571131816) | **Publié:** Aug 28, 2026

---
### Bataille fantastique : Magicien contre Démon de feu

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt vidéo fantastique cinématographique épique mettant en scène un magicien face à un démon de feu géant sur un pont de pierre en ruine, avec un éclairage dramatique en 8K.

#### 📝 Prompt

```
Vidéo fantastique cinématographique épique d'un puissant magicien gris debout sur un pont de pierre en ruine, face à un démon de feu gigantesque, levant son bâton et déclarant « Tu ne passeras pas ! », éclairage dramatique, angles de caméra panoramiques, photoréaliste, 8K.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093419822549757952/img/L5SAmpbdC8ruEuPY.jpg" width="600" alt="Bataille fantastique : Magicien contre Démon de feu">

**[🎬 Voir la vidéo →](https://x.com/Conor_D_Dart/status/2093419950522118605)**

**Auteur:** [Conor Dart](https://x.com/Conor_D_Dart) | **Source:** [Link](https://x.com/Conor_D_Dart/status/2093419950522118605) | **Publié:** Aug 28, 2026

---
### Entraînement d'escalade cinématographique

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt cinématographique de haute qualité pour une vidéo de style photographie sportive, mettant en scène un grimpeur dans une salle moderne avec un éclairage dramatique.

#### 📝 Prompt

```
Magnifique vidéo cinématographique d'un grimpeur s'entraînant dans une salle d'escalade moderne, photographie sportive professionnelle, angles de caméra dynamiques, mouvements réalistes, éclairage dramatique, 8K, esthétique virale pour Twitter.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093387864948011008/img/iNmD5O3-vLLPrTeE.jpg" width="600" alt="Entraînement d'escalade cinématographique">

**[🎬 Voir la vidéo →](https://x.com/Conor_D_Dart/status/2093388008061804767)**

**Auteur:** [Conor Dart](https://x.com/Conor_D_Dart) | **Source:** [Link](https://x.com/Conor_D_Dart/status/2093388008061804767) | **Publié:** Aug 28, 2026

---
### Storyboard pour confiture de fraises de luxe

![English](https://img.shields.io/badge/lang-English-blue)

> Un storyboard complet pour une publicité de confiture de fraises gastronomique, mettant en avant des textures macro, des plans de cuillère au ralenti et une esthétique de petit-déjeuner haut de gamme.

#### 📝 Prompt

```
TITRE :
Storyboard pour publicité de confiture de fraises premium

FORMAT :
• Storyboard premium sur une page
• Format portrait 3:4
• Campagne publicitaire pour petit-déjeuner de luxe
• 8 scènes cinématographiques centrées sur le produit
• Le produit reste l'élément visuel central
• Présentation publicitaire haut de gamme
...
• Fiches d'information :
  - Durée : 20 secondes
  - Style : Publicité pour petit-déjeuner gastronomique
  - Produit : Confiture de fraises
  - Audio : ASMR culinaire doux
• Section « Pourquoi ce style fonctionne »
• Esthétique rouge fraise, crème et rose poudré
• Détails décoratifs minimalistes inspirés des fruits

STORYBOARD :
1. Pot de confiture premium entouré de fraises fraîches
2. Ouverture du couvercle en plan macro extrême
3. Cuillère plongeant lentement dans la confiture de fraises onctueuse
4. Confiture brillante s'étirant de la cuillère au ralenti
5. Morceaux de fraises fraîches tombant dans la confiture
6. Confiture s'étalant délicatement sur une tranche de pain grillé chaud
7. Macro extrême montrant les grains de fraise et la texture riche
...
CAMÉRA :
Macro extrême, étalement au ralenti, composition culinaire en vue de dessus, mouvement de caméra fluide, faible profondeur de champ, packshot premium.
...
<img src="https://cms-assets.youmind.com/media/1787993736055_vz04eo_HQ0vDf8akAAXOp1.jpg" width="600" alt="Storyboard pour confiture de fraises de luxe">

**[🎬 Voir la vidéo →](https://x.com/Strength04_X/status/2093381158356815935)**

**Auteur:** [𝐌](https://x.com/Strength04_X) | **Source:** [Link](https://x.com/Strength04_X/status/2093381158356815935) | **Publié:** Aug 28, 2026

---
### Jeu de zombie pour streamer : combat à la seringue

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de génération vidéo illustrant une streameuse jouant à un jeu d'horreur où une infirmière combat des zombies à l'aide d'une seringue.

#### 📝 Prompt

```
Une streameuse en pleine session de jeu où le personnage principal est une infirmière qui combat des zombies avec une seringue
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093361666260160512/img/DZmjmoHLaqVaRj87.jpg" width="600" alt="Jeu de zombie pour streamer : combat à la seringue">

**[🎬 Voir la vidéo →](https://x.com/DrstaOne/status/2093364188781703596)**
...
> Un prompt vidéo cinématographique pour générer des séquences de haute qualité d'un alpiniste au mont Everest avec une esthétique de photographie professionnelle 8k.

#### 📝 Prompt

```
belle vidéo d'un alpiniste escaladant le mont Everest, photographie professionnelle, 8k, tendance sur Twitter
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093234584049647617/img/vP2tzlpiCT3zr7sd.jpg" width="600" alt="Alpiniste au mont Everest">

**[🎬 Voir la vidéo →](https://x.com/Conor_D_Dart/status/2093234779890102730)**

**Auteur:** [Conor Dart](https://x.com/Conor_D_Dart) | **Source:** [Link](https://x.com/Conor_D_Dart/status/2093234779890102730) | **Publié:** Aug 28, 2026

---
### Commentaire de jeu de zombie par une streameuse

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt vidéo cinématographique pour générer une scène montrant une streameuse en train de jouer et de commenter un jeu de zombies mettant en vedette un personnage d'infirmière.

#### 📝 Prompt

```
Une streameuse commente et joue à un jeu dont le personnage principal est une infirmière combattant des zombies avec une seringue.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093215829534146560/img/Tl3KL8c5NyN2Ivev.jpg" width="600" alt="Commentaire de jeu de zombie par une streameuse">

**[🎬 Voir la vidéo →](https://x.com/rovvmut_/status/2093215928863650296)**

**Auteur:** [Heisenberg](https://x.com/rovvmut_) | **Source:** [Link](https://x.com/rovvmut_/status/2093215928863650296) | **Publié:** Aug 28, 2026

---
### Vidéo macro d'unboxing d'un drone miniature

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt vidéo macro cinématographique montrant le déballage et l'assemblage réalistes d'un minuscule drone pliable sur une table en bois.

#### 📝 Prompt

```
Créez une vidéo macro cinématographique ultra-réaliste montrant le déballage et l'assemblage d'un minuscule drone de style DJI Mini 5 Pro sur une table en bois. Commencez par une petite boîte de vente au détail blanche, puis montrez des mains humaines ouvrant soigneusement l'emballage et sortant le drone pliable miniature. Capturez des gros plans détaillés du drone en train d'être déplié et de ses composants positionnés sur la boîte. Terminez par un plan macro extrême du drone gris compact alors que les voyants de sa batterie arrière s'allument en vert. Éclairage intérieur chaleureux, faible profondeur de champ, textures de peau et de plastique réalistes, mouvements de main fluides, esthétique publicitaire haut de gamme, mouvement de caméra cinématographique, mise au point nette sur le drone, ombres naturelles, photoréalisme 4K, composition verticale 9:16, sans texte ni filigrane.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093197036824965121/img/tqzfGB18jYkI11KI.jpg" width="600" alt="Vidéo macro d'unboxing d'un drone miniature">

**[🎬 Voir la vidéo →](https://x.com/AiwithBloodline/status/2093197063421108689)**

**Auteur:** [Dr Bloodline | AI](https://x.com/AiwithBloodline) | **Source:** [Link](https://x.com/AiwithBloodline/status/2093197063421108689) | **Publié:** Aug 28, 2026

---
### Routine de danse pour studio de réseaux sociaux

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de génération vidéo détaillé pour une femme effectuant une routine de danse rythmée dans un studio, tout en maintenant une cohérence visuelle élevée avec une image de référence.

#### 📝 Prompt

```
Utilisez l'image téléchargée comme référence visuelle exacte. La femme exécute une routine de danse élégante, énergique et fluide pour les réseaux sociaux dans le même studio, vêtue de la même tenue noire. Elle commence par des mouvements de mains gracieux, puis enchaîne avec des pas latéraux coordonnés, des tours doux, des mouvements de bras rythmés et des poses de danse assurées, parfaitement synchronisés sur un rythme pop entraînant. Maintenez la cohérence de son visage, de sa coiffure, de sa tenue, de ses proportions corporelles, de l'arrière-plan du studio et de son apparence générale par rapport à l'image de référence. La caméra suit ses mouvements avec fluidité grâce à un suivi cinématographique subtil, avec des zooms avant et arrière légers et occasionnels, tout en la gardant centrée dans le cadre. Mouvements naturels des cheveux et des vêtements, jeu de jambes réaliste, transitions fluides, performance expressive mais naturelle. Format vertical 9:16, style TikTok/Reels, chorégraphie dynamique, photoréaliste, éclairage de studio cinématographique, détails nets, mouvement fluide, qualité 4K, caméra stable, pas de scintillement, pas de distorsion corporelle, pas de personnes supplémentaires, aucun changement d'arrière-plan ou de tenue.
```

<img src="https://cms-assets.youmind.com/media/1787835143240_37hkbt_HQuD-UTaEAIdG4T.jpg" width="600" alt="Routine de danse pour studio de réseaux sociaux">

**[🎬 Voir la vidéo →](https://x.com/Soaima_Ai/status/2092911609471815890)**

**Auteur:** [Soaima](https://x.com/Soaima_Ai) | **Source:** [Link](https://x.com/Soaima_Ai/status/2092911609471815890) | **Publié:** Aug 27, 2026

---
### Construction cinématographique d'un chemin de fer miniature alpin

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt cinématographique détaillé pour générer une scène macro de haute qualité montrant des mains humaines construisant un viaduc ferroviaire miniature dans un décor alpin.

#### 📝 Prompt

```
Créez une scène cinématographique ultra-réaliste de construction d'un chemin de fer miniature sur un immense viaduc en pierre dans un paysage montagneux alpin à couper le souffle. Commencez par un plan large établissant un élégant pont ferroviaire en pierre enjambant une vallée rocheuse profonde avec une magnifique cascade, des forêts de pins et des montagnes enneigées en arrière-plan. Montrez des mains humaines géantes construisant avec soin un minuscule pont ferroviaire, plaçant des blocs de pierre gris foncé un par un dans une arche détaillée. Transitionnez vers des plans macro en gros plan des mains arrangeant des pavés miniatures et utilisant de petits outils pour affiner la voie ferrée et la surface du pont. Montrez une main époussetant la poussière et les débris des voies ferrées miniatures avec une petite brosse, révélant des rails métalliques très détaillés, des traverses en bois et une maçonnerie réaliste. Enfin, révélez une petite locomotive à vapeur vintage voyageant en douceur sur le viaduc en pierre terminé, libérant une douce vapeur blanche alors qu'elle traverse le paysage montagneux spectaculaire. Style : diorama miniature photoréaliste, cinématographie macro, détails extrêmes, mains réalistes, textures naturelles, profondeur de champ cinématographique, douce lumière du matin, montagnes atmosphériques, vapeur réaliste, mouvements de caméra fluides, faible profondeur de champ, 4K, très détaillé, artisanat satisfaisant, transitions fluides, vertical 9:16.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092821205900480512/img/6q52WU-FMeGjTQC_.jpg" width="600" alt="Construction cinématographique d'un chemin de fer miniature alpin">

**[🎬 Voir la vidéo →](https://x.com/AiwithBloodline/status/2092821267154080235)**

**Auteur:** [Dr Bloodline | AI](https://x.com/AiwithBloodline) | **Source:** [Link](https://x.com/AiwithBloodline/status/2092821267154080235) | **Publié:** Aug 27, 2026

---
### Vidéo réaliste d'un employé de bureau en train de taper

![日本語](https://img.shields.io/badge/lang-日本語-green)

> Un prompt vidéo concis pour Gemini Omni Flash illustrant un employé de bureau japonais concentré sur son ordinateur portable dans un bureau au coucher du soleil, avec des textures cinématographiques réalistes.

#### 📝 Prompt

```
Un employé de bureau japonais d'une trentaine d'années, aux cheveux noirs courts et vêtu d'une veste gris anthracite, prépare des documents de réunion devant son ordinateur portable dans un bureau légèrement encombré, baigné par la lumière naturelle du soir. Un bureau en bois avec des documents éparpillés négligemment se trouve devant lui, et une grande plante verte est placée près de la fenêtre, tout à droite de l'image. Rendu photoréaliste en prises de vues réelles. La peau du personnage présente des pores visibles, de légères irrégularités de teint, des signes de l'âge autour des yeux, de légères cernes et une barbe naissante. La veste gris anthracite laisse apparaître le tissage du tissu et des plis naturels dus au port. Le bureau en bois montre ses veines, de fines rayures et une surface mate et sèche. Un rendu réaliste et quotidien, sans aspect trop lisse. Un grain de film 35 mm fin est présent sur toute l'image. Un employé de bureau japonais d'une trentaine d'années se trouve dans un bureau en soirée ; dans la première partie, il tape intensément sur son ordinateur. Dans la seconde partie, il s'arrête, se penche légèrement en avant, fixe l'écran et expire brièvement. Lumière chaude venant de la fenêtre, texture de film en prises de vues réelles. Ambiance sonore uniquement. Aucune autre personne, aucun texte, aucune distorsion de forme.
```

<img src="https://cms-assets.youmind.com/media/1787835146653_sv0ygw_HQpiNVIbMAAfYeg.jpg" width="600" alt="Vidéo réaliste d'un employé de bureau en train de taper">

**[🎬 Voir la vidéo →](https://x.com/Immersion_cy/status/2092597319246258332)**

**Auteur:** [TOMOZO｜AI](https://x.com/Immersion_cy) | **Source:** [Link](https://x.com/Immersion_cy/status/2092597319246258332) | **Publié:** Aug 26, 2026
...
> Un spot de motion design de 15 secondes pour une cérémonie du thé chinoise, mêlant textures d'encre de Chine et design minimaliste moderne.

#### 📝 Prompt

```
Créez un spot de motion design de 12 plans en 16:9, 24 fps, d'une durée exacte de 15 s. Thème : cérémonie du thé chinoise, design oriental moderne.
Ce film est composé à 80 % de design graphique animé audacieux et à 20 % d'action sur les objets.
Palette : noir encre, blanc papier de riz, rouge vermillon, or mat. Style : minimalisme chinois moderne — les textures d'encre de Chine rencontrent des formes géométriques plates ; les sceaux rouges servent de transition.
PLAN 01 | 0,0-1,2 s - Vide blanc. Un seul caractère chinois géant 「茶」 se dessine par des coups de pinceau, l'encre bavant sur les bords.
PLAN 02 | 1,2-2,4 s - Coupe franche : un cercle vermillon s'agrandit depuis le centre ; le caractère le traverse en blanc.
PLAN 03 | 2,4-3,6 s - Tasse à thé vue de dessus sur fond noir ; la vapeur s'élève et se transforme en rubans d'encre fluides.
PLAN 04 | 3,6-5,0 s - Les rubans d'encre se transforment en une rangée horizontale de feuilles de thé géométriques glissant vers la gauche en rythme.
PLAN 05 | 5,0-6,2 s - Caractère géant 「静」 en or mat sur fond noir ; zoom rapide sur le dernier coup de pinceau.
PLAN 06 | 6,2-7,6 s - Silhouette de théière qui verse ; le filet de thé devient une diagonale vermillon qui divise l'écran.
PLAN 07 | 7,6-9,0 s - Écran divisé : montagnes à l'encre à gauche, aplat vermillon à droite ; une tasse à thé blanche glisse le long de la ligne de séparation.
PLAN 08 | 9,0-10,4 s - Un sceau rouge s'abat violemment avec un tremblement de cadre, révélant 「回甘」 en blanc à l'intérieur du sceau.
PLAN 09 | 10,4-11,8 s - Alternance rapide : trois feuilles de thé, trois formes géométriques, en rythme.
PLAN 10 | 11,8-13,0 s - Tous les éléments fusionnent en un cercle d'encre tourbillonnant.
PLAN 11 | 13,0-14,0 s - Le cercle se transforme en tasse à thé ; une goutte tombe ; ondulation au ralenti.
PLAN 12 | 14,0-15,0 s - Écran de fin : 「茶」 en grand, petit texte anglais "TEA — est. in stillness" en dessous, sceau rouge en bas à droite, maintien.
Règle typographique : chaque caractère doit être parfaitement lisible pendant au moins 12 images avant toute superposition. Utilisez le moins de caractères chinois possible, en grande taille uniquement.
Montage : coupes franches sur le rythme, correspondances graphiques, zooms rapides, transitions par éclaboussures d'encre.
Audio : pincements de guzheng + percussions modernes ; effets sonores synchronisés avec les coupes (swoosh de pinceau, impact de sceau, goutte d'eau).
À NE PAS FAIRE : glyphes supplémentaires, hanzi mal orthographiés ou déformés, dégradés arc-en-ciel, texte en relief 3D, images photoréalistes, caractères ajoutés.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2090160008281415681/img/9P04j3027KBHFiU0.jpg" width="600" alt="Motion design pour une cérémonie du thé chinoise moderne">

**[🎬 Voir la vidéo →](https://x.com/EZheng66099/status/2090160829534511425)**

**Auteur:** [EZ](https://x.com/EZheng66099) | **Source:** [Link](https://x.com/EZheng66099/status/2090160829534511425) | **Publié:** Aug 19, 2026

---
### Storyboard publicitaire pour miel biologique premium

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de storyboard cinématographique complet pour une publicité de miel biologique de luxe. Il détaille huit scènes distinctes mettant en avant la macrophotographie des textures du miel, la physique des liquides au ralenti et des éléments de branding élégants.

#### 📝 Prompt

```
TITRE :
Storyboard pour publicité de miel biologique premium
...
• Fiches d'information :
  ...
  - Produit : Miel biologique
  - Audio : ASMR nature douce
• Section « Pourquoi ce style fonctionne »
• Esthétique crème, ambre et or
• Détails décoratifs minimalistes en nid d'abeille

STORYBOARD :
1. Pot de miel premium posé sur une surface en bois chaleureuse
2. Couvercle du pot s'ouvrant lentement en très gros plan
3. Miel doré soulevé avec une cuillère à miel en bois
4. Miel s'écoulant en un filet soyeux extrêmement lent
5. Plan macro de la texture du miel et de ses reflets naturels
6. Miel coulant sur une tranche de pain grillé chaude
...
CAMÉRA :
Macro extrême, photographie de liquide au ralenti, travelling avant contrôlé, composition vue de dessus, faible profondeur de champ, plan cinématographique héroïque.

STYLE :
Texture de miel ultra-réaliste, physique des liquides réaliste, éclairage naturel chaleureux, photographie culinaire premium, pot en verre brillant, reflets élégants, branding biologique de luxe, 8K.
```

<img src="https://cms-assets.youmind.com/media/1787217318219_jdlgsg_HQF19kdacAATv1I.jpg" width="600" alt="Storyboard publicitaire pour miel biologique premium">

**[🎬 Voir la vidéo →](https://x.com/Strength04_X/status/2090081415924982038)**

**Auteur:** [𝐌](https://x.com/Strength04_X) | **Source:** [Link](https://x.com/Strength04_X/status/2090081415924982038) | **Publié:** Aug 19, 2026
...
<sub>🤖 Ce README est généré automatiquement. Dernière mise à jour : 2026-09-25T23:05:48.101Z</sub>
