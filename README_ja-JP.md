...
> 衛星視点から高精細な気象シミュレーションを生成するためのシネマティックなプロンプト。科学的なラベルとリアルなサウンドデザインを伴う、さまざまな極端な気候システムを特徴としています。
...
**作者:** [Build Fast with AI](https://x.com/BuildFastWithAI) | **ソース:** [Link](https://x.com/BuildFastWithAI/status/2059961447443296380) | **公開日:** May 28, 2026
...
> Gemini Omni 向けに設計された技術プロンプトです。髪型、服装、色味を維持したまま、安定したアニメキャラクターの歩行アニメーションを生成します。
...
**作者:** [タナベ | 動画・音声生成AI解説](https://x.com/tanabe_fragm) | **ソース:** [Link](https://x.com/tanabe_fragm/status/2059781140245057683) | **公開日:** May 27, 2026
...
> アップロードされた地図画像と方向マーカーに基づき、中つ国のロケーションを馬に乗って巡る POV バーチャルツアーを生成するためのプロンプト。

#### 📝 プロンプト

```
添付された地図上の矢印の位置と方向を分析してください。赤い矢印は削除してください。その場所における最も重要な 2 つのロケーションを紹介するバーチャルツアーガイド動画を作成してください。

POV：茶色の馬に乗っている視点。

リアルでざらついたファウンド・フッテージ風の映像。
...
**作者:** [TechHalla](https://x.com/techhalla) | **ソース:** [Link](https://x.com/techhalla/status/2059724218158166537) | **公開日:** May 27, 2026
...
> マットな質感の車体フレームが、アイソメトリックなカメラアングルで光沢のある赤いスポーツカーへと組み上がるアニメーションプロンプトです。

#### 📝 プロンプト

```
2 枚の参照画像を始点と終点として使用し、スポーツカーがパーツごとに素早く組み立てられていく様子を収めた、テンポの速い 10 秒間の動画を作成してください。
- 4 つのホイールが所定の位置に転がり込むところから開始
- 金属製のロッドとサスペンションがその間に素早くカチッとはまる
- エンジンブロックが上から降りてくる
- 外装パネルが四方から飛んできてフレームに装着される
- マットなプライマー塗装から光沢のある赤色へ変化させる
...
**作者:** [Harshith](https://x.com/HarshithLucky3) | **ソース:** [Link](https://x.com/HarshithLucky3/status/2059713624885891271) | **公開日:** May 27, 2026
