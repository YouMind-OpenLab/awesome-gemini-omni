...
**作者:** [Build Fast with AI](https://x.com/BuildFastWithAI) | **ソース:** [Link](https://x.com/BuildFastWithAI/status/2059522490876010600) | **公開日:** May 27, 2026
...
> 地図が広がり、目的地へのチケットが登場する、短編旅行フィルム制作のための詳細なシネマティックプロンプト。

#### 📝 プロンプト

```
[CITY] = TOKYO
[CITY] をテーマにした 10 秒間のシネマティックな旅行回想フィルムを作成してください。
清潔なアイボリー色のデスクの上に、折りたたまれた紙の地図と古い旅行チケットが置かれています。
チケットには目的地である「[CITY]」の文字が印字されています。
...
> シンプルなロゴの 20 種類のバリエーションを、デザインを中央に配置したまま高速でアニメーション表示させるためのプロンプトです。
...
<sub>🤖 このREADMEは自動生成されています。最終更新： 2026-07-03T02:51:36.490Z</sub>
